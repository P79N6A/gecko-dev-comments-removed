...
STDMETHODIMP CExtractCallbackConsole::PrepareOperation(const wchar_t *name, bool , Int32 askExtractMode, const UInt64 *position)
{
...
HRESULT CExtractCallbackConsole::OpenResult(const wchar_t * , HRESULT result, bool encrypted)
{
  (*OutStream) << endl;
  if (result != S_OK)
  {
