...
typedef struct _lcms_LUT_struc LUT, FAR* LPLUT; 
...
{
    if (size > ((size_t) 1024*1024*500)) return NULL;  
...
Fixed32 cdecl ToFixedDomain(int a);              
int     cdecl FromFixedDomain(Fixed32 a);        
