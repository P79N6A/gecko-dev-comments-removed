...
{
       wIn[0] = RGB_8_TO_16(REVERSE_FLAVOR_8(*accum)); accum++; 
       wIn[1] = RGB_8_TO_16(REVERSE_FLAVOR_8(*accum)); accum++; 
       wIn[2] = RGB_8_TO_16(REVERSE_FLAVOR_8(*accum)); accum++; 
       wIn[3] = RGB_8_TO_16(REVERSE_FLAVOR_8(*accum)); accum++; 
...
{
       wIn[0] = REVERSE_FLAVOR_16(*(LPWORD) accum); accum+= 2; 
       wIn[1] = REVERSE_FLAVOR_16(*(LPWORD) accum); accum+= 2; 
       wIn[2] = REVERSE_FLAVOR_16(*(LPWORD) accum); accum+= 2; 
       wIn[3] = REVERSE_FLAVOR_16(*(LPWORD) accum); accum+= 2; 
...
{
       wIn[0] = REVERSE_FLAVOR_16(CHANGE_ENDIAN(*(LPWORD) accum)); accum+= 2; 
       wIn[1] = REVERSE_FLAVOR_16(CHANGE_ENDIAN(*(LPWORD) accum)); accum+= 2; 
       wIn[2] = REVERSE_FLAVOR_16(CHANGE_ENDIAN(*(LPWORD) accum)); accum+= 2; 
       wIn[3] = REVERSE_FLAVOR_16(CHANGE_ENDIAN(*(LPWORD) accum)); accum+= 2; 
...
{
       wIn[0] = wIn[1] = wIn[2] = RGB_8_TO_16(*accum); accum++;     
       return accum;
}
...
{
       wIn[0] = wIn[1] = wIn[2] = REVERSE_FLAVOR_16(RGB_8_TO_16(*accum)); accum++;     
       return accum;
}
...
{
       wIn[0] = wIn[1] = wIn[2] = *(LPWORD) accum; accum+= 2;   
       return accum;
}
