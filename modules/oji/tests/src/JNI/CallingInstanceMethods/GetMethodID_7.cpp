...
JNI_OJIAPITest(JNIEnv_GetMethodID_7)
{
  GET_JNI_FOR_TEST
  ...
  return TestResult::PASS("GetMethodID for public not inherited method (sig = (ZBCSIJFDLjava/lang/String;[Ljava/lang/String;)V) return correct value");
