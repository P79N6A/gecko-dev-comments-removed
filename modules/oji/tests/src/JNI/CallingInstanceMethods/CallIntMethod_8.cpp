...
JNI_OJIAPITest(JNIEnv_CallIntMethod_8)
{
  GET_JNI_FOR_TEST
  ...
  if(value==0){ 
     if((excep != NULL) && (env->IsInstanceOf(excep, clazz_exp))){
       ...
       if(SecENV){
         return TestResult::FAIL("CallIntMethodA for protected inherited from superclass method (sig = (ZBCSIJFDLjava/lang/String;[Ljava/lang/String;)I) return incorrect value");
       }else{
         return TestResult::PASS("CallIntMethodA for protected inherited from superclass method (sig = (ZBCSIJFDLjava/lang/String;[Ljava/lang/String;)I) return correct value");
       }
     }
