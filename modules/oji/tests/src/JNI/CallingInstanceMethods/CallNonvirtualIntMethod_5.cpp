...
JNI_OJIAPITest(JNIEnv_CallNonvirtualIntMethod_5)
{
  GET_JNI_FOR_TEST
  ...
  if((MethodID!=NULL) && (value == 11)){
      return TestResult::PASS("CallNonvirtualIntMethodA with sig = \"()I\" return correct value");
  }else{
      return TestResult::FAIL("CallNonvirtualIntMethodA with sig = \"()I\" return incorrect value");
  }
