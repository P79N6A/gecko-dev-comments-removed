...
#define PRINTUSAGE(subject, option, predicate) \
    ...
    fprintf(stderr, "\n");
    PRINTUSAGE(progName, "[-DEHSVR]", "List available cipher modes"); 
    fprintf(stderr, "\n");
...
static secuCommandFlag bltest_options[] =
{
    ...
    {  'z', PR_FALSE, 0, PR_FALSE },
    {   0 , PR_TRUE,  0, PR_FALSE, "aad" },
    {  '1', PR_TRUE,  0, PR_FALSE },
    {  '2', PR_TRUE,  0, PR_FALSE },
    {  '3', PR_FALSE, 0, PR_FALSE },
    {  '4', PR_TRUE,  0, PR_FALSE },
    {  '5', PR_TRUE,  0, PR_FALSE },
    {  '-', PR_FALSE, 0, PR_FALSE }
};
