...
static int PR_CALLBACK certHashtable_clearEntry(PLHashEntry *he, int , void * )
{
  if (he && he->value) {
...
static CipherPref CipherPrefs[] = {
 ...
 {"security.ssl3.ecdhe_ecdsa_null_sha", TLS_ECDHE_ECDSA_WITH_NULL_SHA}, 
 ...
 {"security.ssl3.ecdhe_rsa_null_sha", TLS_ECDHE_RSA_WITH_NULL_SHA}, 
 ...
 {"security.ssl3.ecdh_ecdsa_null_sha", TLS_ECDH_ECDSA_WITH_NULL_SHA}, 
 ...
 {"security.ssl3.ecdh_rsa_null_sha", TLS_ECDH_RSA_WITH_NULL_SHA}, 
...
nsNSSComponent::InitializeNSS(bool showWarningBox)
{
  ...
  #error "This code assumes XP_MAC and XP_MACOSX will never be defined at the same time"
    ...
    profilePath->Create(nsIFile::DIRECTORY_TYPE, 0); 
