...
const static OCSPResponseName kOCSPResponseNameList[] = {
  ...
  { "goodotherca",     ORTGoodOtherCA},    
                                           
  { "expiredresponse", ORTExpired},        
                                           
  { "oldvalidperiod",  ORTExpiredFreshCA}, 
                                           
  { "empty",           ORTEmpty},          

  { "malformed",       ORTMalformed},      
                                           
  { "serverr",         ORTSrverr},         
                                           
  { "trylater",        ORTTryLater},       
