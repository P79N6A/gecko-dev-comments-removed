...
TEST(FileVersionInfoTest, HardCodedProperties) {
  ...
  const wchar_t* kExpectedValues[1][15] = {
      ...
      L"Goooooogle",                      
      L"Google",                          
      L"This is the product name",        
      L"This is the product short name",  
      L"The Internal Name",               
      L"4.3.2.1",                         
      L"Private build property",          
      L"Special build property",          
      L"This is a particularly interesting comment",  
      L"This is the original filename",   
      L"This is my file description",     
      L"1.2.3.4",                         
      L"This is the legal copyright",     
      L"This is the legal trademarks",    
      L"This is the last change",         
