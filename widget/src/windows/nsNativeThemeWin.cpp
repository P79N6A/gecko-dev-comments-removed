...
RENDER_AGAIN:
  ...
  {
    drawThemeBG(theme, hdc, MENU_POPUPBORDERS,  0, &widgetRect, &clipRect);
    SIZE borderSize;
    ...
    drawThemeBG(theme, hdc, MENU_POPUPBACKGROUND,  0, &bgRect, &clipRect);
    ...
    drawThemeBG(theme, hdc, MENU_POPUPGUTTER,  0, &gutterRect, &clipRect);
  }
  else if (aWidgetType == NS_THEME_MENUSEPARATOR)
  {
    ...
    drawThemeBG(theme, hdc, MENU_POPUPSEPARATOR,  0, &sepRect, &clipRect);
  }
