...
static const uint32_t sTokenBucketProfiles[sNumberTokenBucketProfiles][4] = {
    ...
    { 32, 100, 6, Telemetry::HTTP_PLT_RATE_PACING_0 }, 
    { 16, 100, 6, Telemetry::HTTP_PLT_RATE_PACING_1 }, 
    { 32, 200, 6, Telemetry::HTTP_PLT_RATE_PACING_2 }, 
    { 32, 50, 6, Telemetry::HTTP_PLT_RATE_PACING_3 },  
    { 32, 1, 8, Telemetry::HTTP_PLT_RATE_PACING_4 },   
    { 32, 1, 16, Telemetry::HTTP_PLT_RATE_PACING_5 },  
    { 1000, 1000, 1000, Telemetry::HTTP_PLT_RATE_PACING_6 }, 
};
