...
struct MarkBasePosFormat1
{
  ...
  inline bool apply (hb_apply_context_t *c) const
  {
    ...
    if (!(c->buffer->info[skippy_iter.idx].glyph_props() & HB_OT_LAYOUT_GLYPH_PROPS_BASE_GLYPH)) {}
...
struct MarkLigPosFormat1
{
  ...
  inline bool apply (hb_apply_context_t *c) const
  {
    ...
    if (!(c->buffer->info[skippy_iter.idx].glyph_props() & HB_OT_LAYOUT_GLYPH_PROPS_LIGATURE)) {}
