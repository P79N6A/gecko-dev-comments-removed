...
bool SkWidgetView::postWidgetEvent()
{
 ...
 void SkWidgetView::onInflate(const SkDOM& dom, const SkDOM::Node* node)
{
 ...
 void SkWidgetView::onLabelChange(const char oldLabel[], const char newLabel[])
{
    this->inval(NULL);
}
...
static const char gWidgetEventSinkIDSlotName[] = "sk-widget-sinkid-slot";
 ...
 bool SkWidgetView::onPrepareWidgetEvent(SkEvent* evt)
{
...
SkEventSinkID SkWidgetView::GetWidgetEventSinkID(const SkEvent& evt)
{
 ...
 bool SkButtonView::onEvent(const SkEvent& evt)
{
...
void SkCheckButtonView::setCheckState(CheckState state)
{
 ...
 void SkCheckButtonView::onCheckStateChange(CheckState oldState, CheckState newState)
{
    this->inval(NULL);
}

 void SkCheckButtonView::onInflate(const SkDOM& dom, const SkDOM::Node* node)
{
    this->INHERITED::onInflate(dom, node);
...
static const char gCheckStateSlotName[] = "sk-checkbutton-check-slot";
 ...
 bool SkCheckButtonView::onPrepareWidgetEvent(SkEvent* evt)
{
