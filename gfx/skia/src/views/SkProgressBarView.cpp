...
void SkProgressBarView::changeProgress(int diff)
{
 ...
 void SkProgressBarView::onDraw(SkCanvas* canvas)
{
	SkPaint						paint;		
 ...
 bool SkProgressBarView::onEvent(const SkEvent& evt)
{
 ...
 void SkProgressBarView::onInflate(const SkDOM& dom, const SkDOM::Node* node)
{
 ...
 void SkProgressBarView::onSizeChange()
{
