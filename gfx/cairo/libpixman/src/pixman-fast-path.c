...
FAST_NEAREST(x888_x888_none, 8888, 8888, uint32_t, uint32_t, SRC,  0);
FAST_NEAREST(x888_x888_normal, 8888, 8888, uint32_t, uint32_t, SRC,  1);
FAST_NEAREST(x888_x888_none, 8888, 8888, uint32_t, uint32_t, OVER,  0);
FAST_NEAREST(x888_x888_normal, 8888, 8888, uint32_t, uint32_t, OVER,  1);
FAST_NEAREST(x888_565_none, 8888, 0565, uint32_t, uint16_t, SRC,  0);
FAST_NEAREST(x888_565_normal, 8888, 0565, uint32_t, uint16_t, SRC,  1);
FAST_NEAREST(565_565_none, 0565, 0565, uint16_t, uint16_t, SRC,  0);
FAST_NEAREST(565_565_normal, 0565, 0565, uint16_t, uint16_t, SRC,  1);
FAST_NEAREST(8888_565_none, 8888, 0565, uint32_t, uint16_t, OVER,  0);
FAST_NEAREST(8888_565_normal, 8888, 0565, uint32_t, uint16_t, OVER,  1);
