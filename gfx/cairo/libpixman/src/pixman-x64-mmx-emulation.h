...
__inline __m64 _m_punpcklbw (__m64 m1, __m64 m2)          
{
    unsigned char d[8] =
    {
	m1.m64_u8[0],
...
__inline __m64 _m_punpckhbw (__m64 m1, __m64 m2)          
{
    unsigned char d[8] =
    {
	m1.m64_u8[4],
...
__inline __m64 _m_psrlwi (__m64 a, int n)       
{
    unsigned short d[4] =
    {
	a.m64_u16[0] >> n,
