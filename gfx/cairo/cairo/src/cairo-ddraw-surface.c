...
typedef enum {
    CAIRO_DDRAW_OGL_TEXTURE_SUPPORTED,         
    CAIRO_DDRAW_OGL_TEXTURE_UNUSED,            
    CAIRO_DDRAW_OGL_TEXTURE_IGNORE_WRAP,       
    CAIRO_DDRAW_OGL_TEXTURE_BORDER_IN_SHADER,  
    CAIRO_DDRAW_OGL_TEXTURE_WRAP_IN_SHADER,    
    CAIRO_DDRAW_OGL_TEXTURE_MIRROR_IN_SHADER,  
    CAIRO_DDRAW_OGL_TEXTURE_BORDER_AND_BLEND,  
    CAIRO_DDRAW_OGL_TEXTURE_PAD_AND_WRAP,      
    CAIRO_DDRAW_OGL_TEXTURE_UNSUPPORTED,       
