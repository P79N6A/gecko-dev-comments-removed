...
void Segment::append(const Segment &other)
{
    ...
    CharInfo* pNewCharInfo = new CharInfo[m_numCharinfo+other.m_numCharinfo];		
...
void Segment::read_text(const Face *face, const Features* pFeats, gr_encform enc, const void* pStart, size_t nChars)
{
	assert(face);
	assert(pFeats);
...
void Segment::prepare_pos(const Font * )
{
