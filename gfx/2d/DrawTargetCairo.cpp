...
DrawTargetCairo::CreatePathBuilder(FillRule aFillRule ) const
{
...
void
DrawTargetCairo::WillChange(const Path* aPath )
{
...
DrawTargetCairo::GetUserSpaceClip()
{
  ...
  return Rect(clipX1, clipY1, clipX2 - clipX1, clipY2 - clipY1); 
}
