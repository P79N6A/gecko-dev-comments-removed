...
GLuint Context::createShader(GLenum type)
{
    ...
    while (mShaderMap.find(handle) != mShaderMap.end() || mProgramMap.find(handle) != mProgramMap.end())   
    {
        handle++;
    }
...
GLuint Context::createProgram()
{
    ...
    while (mProgramMap.find(handle) != mProgramMap.end() || mShaderMap.find(handle) != mShaderMap.end())   
    {
        handle++;
    }
