...
public:
    ...
    void GetBufferParameter(JSContext* , GLenum target,
                            GLenum pname,
    ...
    void  GetProgramParameter(JSContext* , WebGLProgram *prog,
                              GLenum pname,
                              JS::MutableHandle<JS::Value> retval) {
    ...
    void GetTexParameter(JSContext * , GLenum target,
                         GLenum pname,
                         JS::MutableHandle<JS::Value> retval) {
