...
GK_ATOM(em, "em")
GK_ATOM(embed, "embed")
GK_ATOM(embeddingLevel, "EmbeddingLevel")                  
...
GK_ATOM(endsInDiacritic, "EndsInDiacritic")                
...
GK_ATOM(MOZcolumnline, "-moz-math-columnline") 
GK_ATOM(MOZfontsize, "-moz-math-font-size") 
GK_ATOM(MOZfontstyle, "-moz-math-font-style") 
GK_ATOM(MOZrowalign, "-moz-math-rowalign")
GK_ATOM(MOZrowline, "-moz-math-rowline") 
GK_ATOM(abs_, "abs")
...
GK_ATOM(rowCursorProperty, "RowCursorProperty") 
GK_ATOM(maxElementWidthProperty, "MaxElementWidthProperty")  
GK_ATOM(outlineInnerRectProperty, "OutlineInnerRectProperty") 
GK_ATOM(outOfFlowDirtyRectProperty, "OutOfFlowDirtyRectProperty") 
GK_ATOM(overflowAreaProperty, "OverflowArea")              
GK_ATOM(overflowProperty, "OverflowProperty")              
GK_ATOM(overflowContainersProperty, "OverflowContainersProperty")             
GK_ATOM(excessOverflowContainersProperty, "ExcessOverflowContainersProperty") 
GK_ATOM(overflowLinesProperty, "OverflowLinesProperty")    
GK_ATOM(overflowOutOfFlowsProperty, "OverflowOutOfFlowsProperty")      
GK_ATOM(overflowPlaceholdersProperty, "OverflowPlaceholdersProperty")  
GK_ATOM(preEffectsBBoxProperty, "PreEffectsBBoxProperty") 
GK_ATOM(preTransformBBoxProperty, "PreTransformBBoxProperty") 
GK_ATOM(rowUnpaginatedHeightProperty, "RowUnpaginatedHeightProperty")  
GK_ATOM(spaceManagerProperty, "SpaceManagerProperty")      
GK_ATOM(tabWidthProperty, "TabWidthProperty")              
GK_ATOM(tableBCProperty, "TableBCProperty")                
GK_ATOM(usedMarginProperty, "UsedMarginProperty") 
GK_ATOM(usedPaddingProperty, "UsedPaddingProperty") 
