...
function testSuccessResponse() {
  ...
  var parameters = [
    
    {
      ...
      requestURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text",
    ...
    },
    {
      ...
      requestURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text",
      responseURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text"
    },
    {
      message: "request to same-origin redirects several times and finally go to same-origin URL",
      requestURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=" + encodeURIComponent("http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text"),
      responseURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text"
    },
    {
      message: "request to same-origin redirect to cross-origin URL",
      requestURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=http://example.com/tests/content/base/test/file_XHRResponseURL.text",
      responseURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.text",
      skip: isInWorker(),
    ...
    },
    {
      ...
      requestURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=" + encodeURIComponent("http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=http://example.com/tests/content/base/test/file_XHRResponseURL.text"),
      responseURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.text",
      skip: isInWorker(),
      reason: "cross-origin redirect request not works on Workers, see bug 882458"
    },
    ...
    
    {
      ...
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.text",
      responseURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.text"
    },
    {
      message: "request to cross-origin redirect back to same-origin URL",
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text",
      responseURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text"
    },
    {
      message: "request to cross-origin redirect to the same cross-origin URL",
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=http://example.com/tests/content/base/test/file_XHRResponseURL.text",
      responseURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.text",
      skip: isInWorker(),
      reason: "cross-origin redirect request not works on Workers, see bug 882458"
    },
    {
      ...
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=http://example.org/tests/content/base/test/file_XHRResponseURL.text",
      responseURL: "http://example.org/tests/content/base/test/file_XHRResponseURL.text",
      skip: isInWorker(),
      reason: "cross-origin redirect request not works on Workers, see bug 882458"
    },
    {
      message: "request to cross-origin redirects several times and finally go to same-origin URL",
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=" + encodeURIComponent("http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text"),
      responseURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text",
      skip: isInWorker(),
      reason: "cross-origin redirect request not works on Workers, see bug 882458"
    },
    {
      ...
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=" + encodeURIComponent("http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=http://example.com/tests/content/base/test/file_XHRResponseURL.text"),
      responseURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.text",
      skip: isInWorker(),
      reason: "cross-origin redirect request not works on Workers, see bug 882458"
    },
    {
      ...
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=" + encodeURIComponent("http://example.com/tests/content/base/test/file_XHRResponseURL.sjs?url=http://example.org/tests/content/base/test/file_XHRResponseURL.text"),
      responseURL: "http://example.org/tests/content/base/test/file_XHRResponseURL.text",
      skip: isInWorker(),
      reason: "cross-origin redirect request not works on Workers, see bug 882458"
    },
  ...
  var parameters = [
    {
      ...
      requestURL: "http://example.com/tests/content/base/test/file_XHRResponseURL_nocors.text"
    },
    {
      message: "should be empty for denied cross-origin request with redirect",
      requestURL: "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=http://example.com/tests/content/base/test/file_XHRResponseURL_nocors.text"
    }
  ];
...
function testNotToLeakResponseURLWhileDoingRedirectsInWindow() {
  ...
  return new Promise(function (aResolve, aReject) {
    xhr.open("GET", "http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.sjs?url=http://mochi.test:8888/tests/content/base/test/file_XHRResponseURL.text");
    xhr.addEventListener("load", function () {
