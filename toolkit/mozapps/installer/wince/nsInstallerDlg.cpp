...
BOOL nsInstallerDlg::OnBtnExtract()
{
  ...
  SendMessageToControl(IDC_PROGRESS, PBM_SETRANGE, 0, (LPARAM) MAKELPARAM (0, 100)); 
...
LRESULT nsInstallerDlg::SendMessageToControl(int nCtlID, UINT Msg, WPARAM wParam , LPARAM lParam )
{
