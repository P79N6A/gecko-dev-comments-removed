...
var TEST_FILES = [
{
  ...
  originalFile     : null,
  compareFile      : null,
  originalPerms    : 7 * 64 + 6 * 8 + 7, 
  comparePerms     : 7 * 64 + 6 * 8 + 7 
}, {
  ...
  originalPerms    : 6 * 64 + 6 * 8 + 6, 
  comparePerms     : 6 * 64 + 4 * 8 + 4 
}, {
  description      : "Added by update.manifest (add)",
  ...
  originalFile     : "partial.png",
  compareFile      : "complete.png",
  originalPerms    : 7 * 64 + 7 * 8 + 7, 
  comparePerms     : 7 * 64 + 5 * 8 + 5 
}, {
  description      : "Added by update.manifest (add)",
  fileName         : "10text0",
  relPathDir       : "a/b/1/10/",
...
function run_test() {
  ...
  if (IS_UNIX) {
    ...
    TEST_FILES.push({
      ...
      originalFile     : null,
      compareFile      : null,
      originalPerms    : 6 * 64 + 6 * 8 + 4, 
      comparePerms     : 6 * 64 + 6 * 8 + 4 
    });
  }
