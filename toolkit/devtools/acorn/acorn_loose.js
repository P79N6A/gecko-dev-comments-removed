...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") return mod(exports, require("./acorn")); 
  if (typeof define == "function" && define.amd) return define(["exports", "./acorn"], mod); 
  mod(self.acorn || (self.acorn = {}), self.acorn); 
