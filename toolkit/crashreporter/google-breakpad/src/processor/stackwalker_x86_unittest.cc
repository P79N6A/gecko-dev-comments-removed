...
TEST_F(CFI, At4003) {
  ...
  raw_context.ebx = 0x53d1379d; 
  raw_context.esi = 0xa97f229d; 
  raw_context.edi = 0xb05cc997; 
  CheckWalk();
}
...
TEST_F(CFI, At4004) {
  ...
  raw_context.ebx = 0x53d1379d; 
  raw_context.esi = 0x0fb7dc4e; 
  raw_context.edi = 0x993b4280; 
  CheckWalk();
}
