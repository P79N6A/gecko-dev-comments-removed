...
typedef struct prstatus {       
  ...
  pid_t          pr_pgrp;       
  pid_t          pr_sid;        
  elf_timeval    pr_utime;      
  elf_timeval    pr_stime;      
  elf_timeval    pr_cutime;     
  elf_timeval    pr_cstime;     
  user_regs_struct pr_reg;      
  uint32_t       pr_fpvalid;    
} prstatus;
