...
def test_base_interface(c):
    ...
    test_attribute(c, "boolean_value", 1, -1, 1) 
    test_attribute(c, "boolean_value", 1, 4, 1) 
    test_attribute(c, "boolean_value", 1, "1", 1) 
    ...
    test_attribute(c, "octet_value", 2, 128) 
    test_attribute(c, "octet_value", 2, 255) 
    test_attribute(c, "octet_value", 2, -1, 255) 
    test_attribute_failure(c, "octet_value", "boo", ValueError)

    test_attribute(c, "short_value", 3, 10)
    test_attribute(c, "short_value", 3, -1) 
    test_attribute(c, "short_value", 3, 0xFFFF, -1) 
    ...
    test_attribute(c, "ushort_value",  4, -1, 0xFFFF) 
    test_attribute(c, "ushort_value",  4, 0xFFFF) 
    ...
    test_attribute_failure(c, "long_long_value", 0xFFFFL * 0xFFFF * 0xFFFF * 0xFFFF, OverflowError) 
    ...
    test_attribute_failure(c, "ulong_long_value", -1, UnsignedMismatchException) 
