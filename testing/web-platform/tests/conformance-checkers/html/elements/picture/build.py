...
errors = {
  ...
  "srcset-microsyntax-plus-w": "<img srcset='x +1w' src=x alt>",
  "srcset-microsyntax-scientific-notation-w": "<img srcset='x 1e0w' src=x alt>",
  "srcset-microsyntax-zero-w": "<img srcset='x 0w' src=x alt>",
  "srcset-microsyntax-negative-zero-w": "<img srcset='x -0w' src=x alt>",
  "srcset-microsyntax-negative-w": "<img srcset='x -1w' src=x alt>",
  ...
  "srcset-microsyntax-x-and-w": "<img srcset='x 1x 1w' src=x alt>",
  "srcset-microsyntax-x-and-h": "<img srcset='x 1x 1h' src=x alt>",
  "srcset-microsyntax-w-and-h": "<img srcset='x 1w 1h' src=x alt>",
  "srcset-microsyntax-h": "<img srcset='x 1h' src=x alt>",
...
non_errors = {
  ...
  "img-src-also-in-srcset-w": "<img src=x srcset='x 100w, y 200w' alt>",
  
  "img-src-not-in-srcset-x": "<img src=x srcset='y 1x, z 2x' alt>",
  "img-src-not-in-srcset-w": "<img src=x srcset='y 100w, z 200w' alt>",
  ...
  "srcset-microsyntax-w": "<img srcset='x 1w' src=x alt>",
