...
new Test.Unit.Runner({
  ...
  testGetValue: function() {
    this.assertEqual('Click Me', Form.Element.getValue('button_type_button')); 
    this.assertEqual(null, Form.Element.getValue('someBorkedId')); 
 	  this.assertEqual(null, Form.Element.getValue('form')); 
 	  this.assertEqual(null, Form.Element.getValue('form')); 
  },
  
  testSetValue: function(){
    
    this.assertEqual(null, Form.Element.setValue('someBorkedId', 'blah')); 
