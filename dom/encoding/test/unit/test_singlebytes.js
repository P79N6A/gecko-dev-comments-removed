...
test(
  "Encoding names",
  function () {
    equal(TextEncoder("utf-8").encoding, "utf-8"); 
    equal(TextEncoder("UTF-16").encoding, "utf-16"); 
    equal(TextEncoder("UTF-16BE").encoding, "utf-16be"); 
    equal(TextDecoder("iso8859-1").encoding, "windows-1252"); 
    equal(TextDecoder("iso-8859-1").encoding, "windows-1252"); 
