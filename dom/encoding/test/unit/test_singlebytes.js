...
test(
  function () {
    assert_equals(TextDecoder("utf-8").encoding, "utf-8"); 
    assert_equals(TextDecoder("UTF-16").encoding, "utf-16le"); 
    assert_equals(TextDecoder("UTF-16BE").encoding, "utf-16be"); 
    assert_equals(TextDecoder("iso8859-1").encoding, "windows-1252"); 
    assert_equals(TextDecoder("iso-8859-1").encoding, "windows-1252"); 
  },
  "Encoding names"
);
