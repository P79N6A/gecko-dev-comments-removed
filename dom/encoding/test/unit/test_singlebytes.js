...
test(
  function() {
    var bad = [
      { encoding: 'utf-8', input: [0xC0] }, 
      { encoding: 'utf-8', input: [0xC0, 0x00] }, 
      { encoding: 'utf-8', input: [0xC0, 0xC0] }, 
      { encoding: 'utf-8', input: [0xE0] }, 
      { encoding: 'utf-8', input: [0xE0, 0x00] }, 
      { encoding: 'utf-8', input: [0xE0, 0xC0] }, 
      { encoding: 'utf-8', input: [0xE0, 0x80, 0x00] }, 
      { encoding: 'utf-8', input: [0xE0, 0x80, 0xC0] }, 
      { encoding: 'utf-8', input: [0xFC, 0x80, 0x80, 0x80, 0x80, 0x80] }, 
      { encoding: 'utf-16le', input: [0x00] }, 
      { encoding: 'utf-16le', input: [0x00, 0xd8] }, 
      { encoding: 'utf-16le', input: [0x00, 0xd8, 0x00, 0x00] }, 
      { encoding: 'utf-16le', input: [0x00, 0xdc, 0x00, 0x00] }, 
      { encoding: 'utf-16le', input: [0x00, 0xdc, 0x00, 0xd8] }  
...
test(
  function () {
    ...
    assert_equals(new TextDecoder("UTF-16").encoding, "utf-16le"); 
    assert_equals(new TextDecoder("UTF-16BE").encoding, "utf-16be"); 
    assert_equals(new TextDecoder("iso8859-1").encoding, "windows-1252"); 
    assert_equals(new TextDecoder("iso-8859-1").encoding, "windows-1252"); 
  },
  "Encoding names"
);
