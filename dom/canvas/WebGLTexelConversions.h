...
const uint16_t kFloat16Value_Zero     = 0x0000; 
const uint16_t kFloat16Value_One      = 0x3C00; 
const uint16_t kFloat16Value_Infinity = 0x7C00; 
const uint16_t kFloat16Value_NaN      = 0x7FFF; 
