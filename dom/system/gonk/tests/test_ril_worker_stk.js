...
add_test(function test_stk_proactive_command_open_channel() {
  ...
  test_stk_proactive_command({
    pdu: [
      ...
      0x82, 0x02, 0x81, 0x82,
      0x85, 0x05, 0x43, 0x6C, 0x6F, 0x73, 0x65 
    ],
  ...
  test_stk_proactive_command({
    pdu: [
      ...
      0x82, 0x02, 0x81, 0x82,
      0x85, 0x07, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65 
    ],
...
add_test(function test_stk_event_download_location_status() {
  ...
  buf.sendParcel = function() {
    ...
    equal(pduHelper.readHexOctet(), 0x21); 
