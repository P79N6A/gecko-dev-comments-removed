...
BrowserElementParentFactory.prototype = {
  ...
  _init: function() {
    ...
    os.addObserver(this, 'in-process-browser-or-app-frame-shown',  true);
  },
...
function BrowserElementParent(frameLoader, hasRemoteFrame) {
  ...
  os.addObserver(this, 'ask-children-to-exit-fullscreen',  true);
  os.addObserver(this, 'oop-frameloader-crashed',  true);
