...
JSObject*
InitEventTargetClass(JSContext* aCx, JSObject* aObj, JSObject* aProto)
{
  return aProto ?
         JS_InitClass(aCx, aObj, aProto, &gMainThreadClass, Construct, 0, NULL,
                      gFunctions, NULL, NULL) :
         JS_InitClass(aCx, aObj, NULL, &gClass, Construct, 0, NULL, gFunctions,
                      NULL, NULL);
}
