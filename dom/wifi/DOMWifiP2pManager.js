...
const DOMWIFIP2PMANAGER_CONTRACTID = "@mozilla.org/wifip2pmanager;1";
const DOMWIFIP2PMANAGER_CID        = Components.ID("{8d9125a0-3498-11e3-aa6e-0800200c9a66}");

function DOMWifiP2pManager() {
...
function debug(msg) {
  if (DEBUG) {
    dump('-------------- DOMWifiP2pManager: ' + msg);
  }
}

DOMWifiP2pManager.prototype = {
  __proto__: DOMRequestIpcHelper.prototype,

  classID:        DOMWIFIP2PMANAGER_CID,
  contractID:     DOMWIFIP2PMANAGER_CONTRACTID,
...
this.NSGetFactory = XPCOMUtils.generateNSGetFactory([DOMWifiP2pManager, WifiP2pGroupOwner]);
