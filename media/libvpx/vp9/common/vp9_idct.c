...
void vp9_high_iht4x4_16_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  const high_transform_2d IHT_4[] = {
    { high_idct4, high_idct4  },    
    { high_iadst4, high_idct4 },    
    { high_idct4, high_iadst4 },    
    { high_iadst4, high_iadst4 }    
  };
  uint16_t *dest = CONVERT_TO_SHORTPTR(dest8);
...
static const high_transform_2d HIGH_IHT_8[] = {
  { high_idct8,  high_idct8  },  
  { high_iadst8, high_idct8  },  
  { high_idct8,  high_iadst8 },  
  { high_iadst8, high_iadst8 }   
};
...
static const high_transform_2d HIGH_IHT_16[] = {
  { high_idct16,  high_idct16  },  
  { high_iadst16, high_idct16  },  
  { high_idct16,  high_iadst16 },  
  { high_iadst16, high_iadst16 }   
};
