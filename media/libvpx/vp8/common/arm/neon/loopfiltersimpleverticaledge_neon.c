...
static INLINE void vp8_loop_filter_simple_vertical_edge_neon(
    ...
    q3u8 = vcombine_u8(d0u8x4.val[0], d1u8x4.val[0]);  
    q4u8 = vcombine_u8(d0u8x4.val[2], d1u8x4.val[2]);  
    q5u8 = vcombine_u8(d0u8x4.val[1], d1u8x4.val[1]);  
    q6u8 = vcombine_u8(d0u8x4.val[3], d1u8x4.val[3]);  
    ...
    d2u8x2.val[0] = vget_low_u8(q6u8);   
    d2u8x2.val[1] = vget_low_u8(q7u8);   
    d3u8x2.val[0] = vget_high_u8(q6u8);  
    d3u8x2.val[1] = vget_high_u8(q7u8);  
