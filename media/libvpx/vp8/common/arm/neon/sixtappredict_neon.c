...
void vp8_sixtap_predict4x4_neon(
    ...
    d0u32x2 = vzip_u32(vreinterpret_u32_u8(d18u8),  
                       vreinterpret_u32_u8(d19u8));
    d1u32x2 = vzip_u32(vreinterpret_u32_u8(d20u8),  
    ...
    d0u32x2 = vzip_u32(vreinterpret_u32_u8(vget_low_u8(q3u8)),  
                       vreinterpret_u32_u8(vget_high_u8(q3u8)));
    d1u32x2 = vzip_u32(vreinterpret_u32_u8(vget_low_u8(q5u8)),  
    ...
    d0u32x2 = vzip_u32(vreinterpret_u32_u64(vget_low_u64(q9u64)),   
                       vreinterpret_u32_u64(vget_high_u64(q9u64)));
    d1u32x2 = vzip_u32(vreinterpret_u32_u64(vget_low_u64(q10u64)),  
    ...
    d0u32x2 = vzip_u32(vreinterpret_u32_u64(vget_low_u64(q3u64)),  
                       vreinterpret_u32_u64(vget_high_u64(q3u64)));
    d1u32x2 = vzip_u32(vreinterpret_u32_u64(vget_low_u64(q5u64)),  
