...
void vp8_short_idct4x4llm_neon(
    ...
    q1s16 = vcombine_s16(d2, d4);  
    q2s16 = vcombine_s16(d3, d5);

    q3s16 = vqdmulhq_n_s16(q2s16, sinpi8sqrt2);
    q4s16 = vqdmulhq_n_s16(q2s16, cospi8sqrt2minus1);

    d12 = vqadd_s16(vget_low_s16(q1s16), vget_high_s16(q1s16));  
    d13 = vqsub_s16(vget_low_s16(q1s16), vget_high_s16(q1s16));  
    ...
    d10 = vqsub_s16(vget_low_s16(q3s16), vget_high_s16(q4s16));  
    d11 = vqadd_s16(vget_high_s16(q3s16), vget_low_s16(q4s16));  
