...
{  
   cc_call_conference_ref_t              callConference   = NULL;    
   cc_call_conference_participant_ref_t  participant      = NULL;    
   cc_uint16_t                           participantIndex = 0;       
   cc_uint16_t                           nodeCount        = 0;       
...
{  
   cc_call_conference_ref_t callConference;    
