...
typedef struct
{
    ...
    char        displayname[MAX_LINE_NAME_SIZE]; 
...
var_t prot_cfg_table[CFGID_PROTOCOL_MAX+1] = {
 {"startMediaPort",CFGVAR(media_port_start),       PA_INT, PR_INT, 0},
  ...
  {"sipInviteRetx", CFGVAR(sip_invite_retx),        PA_INT, PR_INT, 0},
  ...
  {"callStats", CFGVAR(call_stats),             PA_INT, PR_INT, 0},
  ...
  {"ccm2_isValid", CFGVAR(ccm[1].is_valid),        PA_INT, PR_INT, 0},
  ...
  {"timerKeepaliveExpires", CFGVAR(timer_keepalive_expires),PA_INT, PR_INT, 0},
  ...
  {"rollover", CFGVAR(rollover),               PA_INT, PR_INT, 0},
  ...
  {"myActiveMacAddr", CFGVAR(my_active_mac_addr),            PA_STR, PR_MAC, 0},
  {"DscpAudio", CFGVAR(dscp_audio), PA_INT, PR_INT, 0},
 ...
 {"joinDxferPolicy", CFGVAR(join_dxfer_policy), PA_STR, PR_STR, 0},
