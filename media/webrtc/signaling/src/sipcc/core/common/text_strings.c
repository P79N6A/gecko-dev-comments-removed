...
debug_string_table_entry debug_string_table [] = {
    {0},                                            
    {use_str(DEBUG_SEPARATOR_BAR)},                 
    {use_str(DEBUG_CONSOLE_PASSWORD)},              
    {use_str(DEBUG_CONSOLE_KEYWORD_CONSOLE_STALL)}, 
    {use_str(DEBUG_CONSOLE_KEYWORD_MEMORYMAP)},     
    {use_str(DEBUG_CONSOLE_KEYWORD_MALLOCTABLE)},   
    {use_str(DEBUG_CONSOLE_KEYWORD_MEMORYDUMP)},    
    {use_str(DEBUG_CONSOLE_KEYWORD_DNS)},           
    {use_str(DEBUG_CONSOLE_KEYWORD_DSPSTATE)},      
    {use_str(DEBUG_CONSOLE_USAGE_MEMORYDUMP)},      
    {use_str(DEBUG_CONSOLE_BREAK)},                 
    {use_str(DEBUG_FUNCTION_ENTRY)},                
    {use_str(DEBUG_FUNCTION_ENTRY2)},               
    {use_str(DEBUG_SIP_ENTRY)},                     
    {use_str(DEBUG_SIP_URL_ERROR)},                 
    {use_str(DEBUG_LINE_NUMBER_INVALID)},           
    {use_str(DEBUG_SIP_SPI_SEND_ERROR)},            
    {use_str(DEBUG_SIP_SDP_CREATE_BUF_ERROR)},      
    {use_str(DEBUG_SIP_PARSE_SDP_ERROR)},           
    {use_str(DEBUG_SIP_FEATURE_UNSUPPORTED)},       
    {use_str(DEBUG_SIP_DEST_SDP)},                  
    {use_str(DEBUG_SIP_MSG_SENDING_REQUEST)},       
    {use_str(DEBUG_SIP_MSG_SENDING_RESPONSE)},      
    {use_str(DEBUG_SIP_MSG_RECV)},                  
    {use_str(DEBUG_SIP_STATE_UNCHANGED)},           
    {use_str(DEBUG_SIP_FUNCTIONCALL_FAILED)},       
    {use_str(DEBUG_SIP_BUILDFLAG_ERROR)},           
    {use_str(DEBUG_GENERAL_FUNCTIONCALL_FAILED)},   
    {use_str(DEBUG_GENERAL_SYSTEMCALL_FAILED)},     
    {use_str(DEBUG_GENERAL_FUNCTIONCALL_BADARGUMENT)}, 
    {use_str(DEBUG_FUNCTIONNAME_SIPPMH_PARSE_FROM)},
    {use_str(DEBUG_FUNCTIONNAME_SIPPMH_PARSE_TO)},  
    {use_str(DEBUG_FUNCTIONNAME_SIP_SM_REQUEST_CHECK_AND_STORE)}, 
    {use_str(DEBUG_SNTP_LI_ERROR)},                 
    {use_str(DEBUG_SNTP_MODE_ERROR)},               
    {use_str(DEBUG_SNTP_STRATUM_ERROR)},            
    {use_str(DEBUG_SNTP_TIMESTAMP_ERROR)},          
    {use_str(DEBUG_SNTP_TIMESTAMP1)},               
    {use_str(DEBUG_SNTP_TIMESTAMP2)},               
    {use_str(DEBUG_SNTP_TIME_UPDATE)},              
    {use_str(DEBUG_SNTP_TS_HEADER)},                
    {use_str(DEBUG_SNTP_TS_PRINT)},                 
    {use_str(DEBUG_SNTP_SOCKET_REOPEN)},            
    {use_str(DEBUG_SNTP_DISABLED)},                 
    {use_str(DEBUG_SNTP_REQUEST)},                  
    {use_str(DEBUG_SNTP_RESPONSE)},                 
    {use_str(DEBUG_SNTP_RETRANSMIT)},               
    {use_str(DEBUG_SNTP_UNICAST_MODE)},             
    {use_str(DEBUG_SNTP_MULTICAST_MODE)},           
    {use_str(DEBUG_SNTP_ANYCAST_MODE)},             
    {use_str(DEBUG_SNTP_VALIDATION)},               
    {use_str(DEBUG_SNTP_VALIDATION_PACKET)},        
    {use_str(DEBUG_SNTP_WRONG_SERVER)},             
    {use_str(DEBUG_SNTP_NO_REQUEST)},               
    {use_str(DEBUG_SNTP_ANYCAST_RESET)},            
    {use_str(DEBUG_SOCKET_UDP_RTP)},                
    {use_str(DEBUG_MAC_PRINT)},                     
    {use_str(DEBUG_IP_PRINT)},                      
    {use_str(DEBUG_SYSBUF_UNAVAILABLE)},            
    {use_str(DEBUG_MSG_BUFFER_TOO_BIG)},            
    {use_str(DEBUG_UNKNOWN_TIMER_BLOCK)},           
    {use_str(DEBUG_CREDENTIALS_BAG_CORRUPTED)},     
    {use_str(DEBUG_INPUT_NULL)},                    
    {use_str(DEBUG_INPUT_EMPTY)},                   
    {use_str(DEBUG_STRING_DUP_FAILED)},             
    {use_str(DEBUG_PARSER_STRING_TOO_LARGE)},       
    {use_str(DEBUG_PARSER_NULL_KEY_TABLE)},         
    {use_str(DEBUG_PARSER_UNKNOWN_KEY)},            
    {use_str(DEBUG_PARSER_UNKNOWN_KEY_ENUM)},       
    {use_str(DEBUG_PARSER_INVALID_START_VAR)},      
    {use_str(DEBUG_PARSER_INVALID_VAR_CHAR)},       
    {use_str(DEBUG_PARSER_MISSING_COLON)},          
    {use_str(DEBUG_PARSER_NO_VALUE)},               
    {use_str(DEBUG_PARSER_EARLY_EOL)},              
    {use_str(DEBUG_PARSER_INVALID_VAR_NAME)},       
    {use_str(DEBUG_PARSER_INVALID_VAR_VALUE)},      
    {use_str(DEBUG_PARSER_UNKNOWN_VAR)},            
    {use_str(DEBUG_PARSER_NAME_VALUE)},             
    {use_str(DEBUG_PARSER_UNKNOWN_NAME_VALUE)},     
    {use_str(DEBUG_PARSER_UNKNOWN_ERROR)},          
    {use_str(DEBUG_PARSER_NUM_ERRORS)},             
    {use_str(DEBUG_PARSER_SET_DEFAULT)},            
    {use_str(DEBUG_SDP_ERROR_BODY_FIELD)},          
    {use_str(DEBUG_UDP_OPEN_FAIL)},                 
    {use_str(DEBUG_UDP_PAYLOAD_TOO_LARGE)},         
    {use_str(DEBUG_RTP_TRANSPORT)},                 
    {use_str(DEBUG_RTP_INVALID_VOIP_TYPE)},         
    {use_str(DEBUG_RTP_INVALID_RTP_TYPE)},          
    {use_str(DEBUG_MEMORY_ALLOC)},                  
    {use_str(DEBUG_MEMORY_FREE)},                   
    {use_str(DEBUG_MEMORY_MALLOC_ERROR)},           
    {use_str(DEBUG_MEMORY_REALLOC_ERROR)},          
    {use_str(DEBUG_MEMORY_OUT_OF_MEM)},             
    {use_str(DEBUG_MEMORY_ENTRY)},                  
    {use_str(DEBUG_MEMORY_SUMMARY)},                
    {use_str(DEBUG_MEMORY_ADDRESS_HEADER)},         
    {use_str(DEBUG_MEMORY_DUMP)},                   
    {use_str(DEBUG_DNS_GETHOSTBYNAME)},             
    {use_str(DEBUG_PMH_INCORRECT_SYNTAX)},          
    {use_str(DEBUG_PMH_INVALID_FIELD_VALUE)},       
    {use_str(DEBUG_PMH_INVALID_SCHEME)},            
    {use_str(DEBUG_PMH_UNKNOWN_SCHEME)},            
    {use_str(DEBUG_PMH_NOT_ENOUGH_PARAMETERS)},     
    {use_str(DEBUG_REG_DISABLED)},                  
    {use_str(DEBUG_REG_PROXY_EXPIRES)},             
    {use_str(DEBUG_REG_SIP_DATE)},                  
    {use_str(DEBUG_REG_SIP_RESP_CODE)},             
    {use_str(DEBUG_REG_SIP_RESP_FAILURE)},          
    {use_str(DEBUG_REG_INVALID_LINE)},              
    {use_str(CC_NO_MSG_BUFFER)},                    
    {use_str(CC_SEND_FAILURE)},                     
    {use_str(GSM_UNDEFINED)},                       
    {use_str(GSM_DBG_PTR)},                         
    {use_str(GSM_FUNC_ENTER)},                      
    {use_str(GSM_DBG1)},                            
    {use_str(FSM_DBG_SM_DEFAULT_EVENT)},            
    {use_str(FSM_DBG_SM_FTR_ENTRY)},                
    {use_str(FSM_DBG_FAC_ERR)},                     
    {use_str(FSM_DBG_FAC_FOUND)},                   
    {use_str(FSM_DBG_IGNORE_FTR)},                  
    {use_str(FSM_DBG_IGNORE_SRC)},                  
    {use_str(FSM_DBG_CHANGE_STATE)},                
    {use_str(FSM_DBG_SDP_BUILD_ERR)},               
    {use_str(FSMDEF_DBG_PTR)},                      
    {use_str(FSMDEF_DBG1)},                         
    {use_str(FSMDEF_DBG2)},                         
    {use_str(FSMDEF_DBG_SDP)},                      
    {use_str(FSMDEF_DBG_CLR_SPOOF_APPLD)},          
    {use_str(FSMDEF_DBG_CLR_SPOOF_RQSTD)},          
    {use_str(FSMDEF_DBG_INVALID_DCB)},              
    {use_str(FSMDEF_DBG_FTR_REQ_ACT)},              
    {use_str(FSMDEF_DBG_TMR_CREATE_FAILED)},        
    {use_str(FSMDEF_DBG_TMR_START_FAILED)},         
    {use_str(FSMDEF_DBG_TMR_CANCEL_FAILED)},        
    {use_str(FSMXFR_DBG_XFR_INITIATED)},            
    {use_str(FSMXFR_DBG_PTR)},                      
    {use_str(FSMCNF_DBG_CNF_INITIATED)},            
    {use_str(FSMCNF_DBG_PTR)},                      
    {use_str(FSMB2BCNF_DBG_CNF_INITIATED)},         
    {use_str(FSMB2BCNF_DBG_PTR)},                   
    {use_str(FSMSHR_DBG_BARGE_INITIATED)},          
    {use_str(LSM_DBG_ENTRY)},                       
    {use_str(LSM_DBG_INT1)},                        
    {use_str(LSM_DBG_CC_ERROR)},                    
    {use_str(VCM_DEBUG_ENTRY)},                     
    {use_str(SM_PROCESS_EVENT_ERROR)},              
    {use_str(REG_SM_PROCESS_EVENT_ERROR)},          
    {0},
};
