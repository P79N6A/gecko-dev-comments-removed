...
typedef struct cc_msgbody_info_t_ {
        uint32_t          num_parts;            
        cc_content_type_t content_type;         
        cc_msgbody_t  parts[CC_MAX_BODY_PARTS]; 
} cc_msgbody_info_t;
...
typedef struct cc_media_cap_t_ {
    cc_media_cap_name name;          
    sdp_media_e       type;          
    boolean           enabled;       
    boolean           support_security; 
...
typedef struct cc_media_cap_table_t_ {
    uint32_t        id;
    cc_media_cap_t  cap[CC_MAX_MEDIA_CAP];
...
typedef struct cc_onhook_t_ {
    ...
    cc_hold_resume_reason_e hold_resume_reason; 
    cc_onhook_reason_e  active_list;                 
