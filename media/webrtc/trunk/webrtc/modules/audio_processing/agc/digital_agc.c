                                     ...
                                     int16_t analogTarget) 
{
    ...
    for (i = 0; i < 32; i++)
    {
        ...
        inLevel = WEBRTC_SPL_LSHIFT_W32((int32_t)diffGain, 14) - inLevel; 
        ...
        tmpU32no1 += WEBRTC_SPL_LSHIFT_U32((uint32_t)kGenFuncTable[intPart], 14); 
        ...
        numFIX -= WEBRTC_SPL_MUL_32_16((int32_t)logApprox, diffGain); 
