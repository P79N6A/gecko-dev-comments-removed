...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    assert(-1 == h263Information.GetInfo(encodedBuffer, length, ptrInfoSQCIF)); 
    ...
    assert(-1 == h263Information.GetMBInfo(encodedBuffer, length, -1, ptrMBInfoSQCIF)); 
    assert(-1 == h263Information.GetMBInfo(encodedBuffer, length, 8, ptrMBInfoSQCIF));  
