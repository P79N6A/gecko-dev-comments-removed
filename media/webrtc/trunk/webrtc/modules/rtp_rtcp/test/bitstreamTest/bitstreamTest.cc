...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    const WebRtc_UWord16 maxBitrareCalcWindow[numberOfLayers] = {200, 200,200,200};
    ...
    for(int i = 0; i<= numberOfLayers-1; i++)
    {
        ...
        builderScalabilityInfo.Add1Bit(1);    
        ...
        builderScalabilityInfo.AddUE(0); 
        builderScalabilityInfo.AddUE(0); 
    }
    ...
    for(WebRtc_UWord32 j = 0; j<= numberOfLayersMinusOne; j++)
    {
        ...
        const WebRtc_UWord8 exact_inter_layer_pred_flag = parserScalabilityInfo.Get1Bit();  
        ...
        const WebRtc_UWord8 layer_output_flag = parserScalabilityInfo.Get1Bit();  
