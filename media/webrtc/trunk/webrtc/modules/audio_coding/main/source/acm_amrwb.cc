...
int16_t ACMAMRwb::DecodeSafe(uint8_t* ,
                             int16_t ,
                             int16_t* ,
                             int16_t* ,
                             int8_t* ) {
...
int32_t ACMAMRwb::CodecDef(WebRtcNetEQ_CodecDef& ,
                           const CodecInst& ) {
  return -1;
}
...
int16_t ACMAMRwb::SetBitRateSafe(const int32_t ) {
  return -1;
}
