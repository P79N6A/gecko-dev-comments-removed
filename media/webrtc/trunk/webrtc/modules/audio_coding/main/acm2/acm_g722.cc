...
int32_t ACMG722::Add10MsDataSafe(const uint32_t ,
                                 const int16_t* ,
                                 const uint16_t ,
                                 const uint8_t ) {
  return -1;
...
int16_t ACMG722::InternalEncode(uint8_t* ,
                                int16_t* ) {
  return -1;
}

int16_t ACMG722::InternalInitEncoder(WebRtcACMCodecParams* ) {
  return -1;
}
...
void ACMG722::InternalDestructEncoderInst(void* ) { return; }
