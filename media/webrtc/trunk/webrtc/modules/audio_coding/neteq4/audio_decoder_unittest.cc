...
class AudioDecoderIlbcTest : public AudioDecoderTest {
 protected:
  ...
  virtual void InitEncoder() {
    ASSERT_EQ(0, WebRtcIlbcfix_EncoderInit(encoder_, 30));  
  }
...
class AudioDecoderIsacFloatTest : public AudioDecoderTest {
 protected:
  ...
  virtual void InitEncoder() {
    ASSERT_EQ(0, WebRtcIsac_EncoderInit(encoder_, 1));  
    ASSERT_EQ(0, WebRtcIsac_Control(encoder_, 32000, 30));  
  }
...
class AudioDecoderIsacFixTest : public AudioDecoderTest {
 protected:
  ...
  virtual void InitEncoder() {
    ASSERT_EQ(0, WebRtcIsacfix_EncoderInit(encoder_, 1));  
    ASSERT_EQ(0,
              WebRtcIsacfix_Control(encoder_, 32000, 30));  
  }
