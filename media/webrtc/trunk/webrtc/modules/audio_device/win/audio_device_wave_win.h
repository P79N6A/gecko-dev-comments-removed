...
private:
    ...
    uint16_t                          _dTcheckPlayBufDelay;   
    uint16_t                          _playBufDelay;          
    uint16_t                          _playBufDelayFixed;     
    uint16_t                          _minPlayBufDelay;       
    uint16_t                          _MAX_minBuffer;         

    int32_t                           _erZeroCounter;         
    int32_t                           _intro;
    ...
    uint32_t                          _recordedBytes;         
    uint32_t                          _prevRecByteCheckTime;  
