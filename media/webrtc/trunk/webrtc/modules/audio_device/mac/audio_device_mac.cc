...
int32_t
AudioDeviceMac::WaveOutVolume(uint16_t& ,
                              uint16_t& ) const
{
...
int32_t
AudioDeviceMac::SetRecordingDevice(AudioDeviceModule::WindowsDeviceType )
{
    WEBRTC_TRACE(kTraceError, kTraceAudioDevice, _id,
                 "WindowsDeviceType not supported");
    return -1;
...
int32_t AudioDeviceMac::CPULoad(uint16_t& ) const
{
