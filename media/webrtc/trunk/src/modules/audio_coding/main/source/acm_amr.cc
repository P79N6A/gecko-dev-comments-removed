...
WebRtc_Word16 ACMAMR::InternalEncode(WebRtc_UWord8* ,
                                     WebRtc_Word16* ) {
  return -1;
}

WebRtc_Word16 ACMAMR::DecodeSafe(WebRtc_UWord8* ,
                                 WebRtc_Word16 ,
                                 WebRtc_Word16* ,
                                 WebRtc_Word16* ,
                                 WebRtc_Word8* ) {
...
WebRtc_Word32 ACMAMR::CodecDef(WebRtcNetEQ_CodecDef& ,
                               const CodecInst& ) {
  return -1;
}
...
WebRtc_Word16 ACMAMR::SetBitRateSafe(const WebRtc_Word32 ) {
  return -1;
}

void ACMAMR::InternalDestructEncoderInst(void* ) {
  return;
}
...
WebRtc_Word16 ACMAMR::UnregisterFromNetEqSafe(ACMNetEQ* ,
                                              WebRtc_Word16 ) {
  return -1;
}
