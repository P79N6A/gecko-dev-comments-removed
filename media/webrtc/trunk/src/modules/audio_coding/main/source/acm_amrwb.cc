...
ACMAMRwb::ACMAMRwb(WebRtc_Word16 )
...
WebRtc_Word16 ACMAMRwb::InternalEncode(WebRtc_UWord8* ,
                                       WebRtc_Word16* ) {
  return -1;
}

WebRtc_Word16 ACMAMRwb::DecodeSafe(WebRtc_UWord8* ,
                                   WebRtc_Word16 ,
                                   WebRtc_Word16* ,
                                   WebRtc_Word16* ,
                                   WebRtc_Word8* ) {
...
WebRtc_Word32 ACMAMRwb::CodecDef(WebRtcNetEQ_CodecDef& ,
                                 const CodecInst& ) {
  return -1;
}
...
WebRtc_Word16 ACMAMRwb::SetBitRateSafe(const WebRtc_Word32 ) {
  return -1;
}

void ACMAMRwb::InternalDestructEncoderInst(void* ) {
  return;
}
