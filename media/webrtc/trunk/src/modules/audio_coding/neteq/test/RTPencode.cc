...
#endif
#ifdef CODEC_SPEEX_16
        else if (coder==kDecoderSPEEX_16) { 
            int encodedLen = 0;
            int retVal = 1;
            while (retVal == 1 && encodedLen < frameLen) {
