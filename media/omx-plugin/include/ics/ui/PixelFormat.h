...
enum {
    ...
    PIXEL_FORMAT_A_8         = GGL_PIXEL_FORMAT_A_8,        
    PIXEL_FORMAT_L_8         = GGL_PIXEL_FORMAT_L_8,        
    PIXEL_FORMAT_LA_88       = GGL_PIXEL_FORMAT_LA_88,      
    PIXEL_FORMAT_RGB_332     = GGL_PIXEL_FORMAT_RGB_332,    
