...
CSS_PROP_SHORTHAND(border-left-style, border_left_style, BorderLeftStyle) 
#ifndef CSS_PROP_LIST_EXCLUDE_INTERNAL
...
CSS_PROP_SHORTHAND(border-right-style, border_right_style, BorderRightStyle) 
#ifndef CSS_PROP_LIST_EXCLUDE_INTERNAL
...
CSS_PROP_CONTENT(counter-increment, counter_increment, CounterIncrement, Content, mCounterIncrement, eCSSType_ValuePairList, nsnull) 
CSS_PROP_CONTENT(counter-reset, counter_reset, CounterReset, Content, mCounterReset, eCSSType_ValuePairList, nsnull) 
