...
ctype<char>::classic_table() _STLP_NOTHROW {
  ...
  static const ctype_base::mask _S_classic_table[table_size] = {
    ...
    ctype_base::mask(punct | print) ,
    ctype_base::mask(punct | print) ,
    ctype_base::mask(digit | print | xdigit) ,
    ctype_base::mask(digit | print | xdigit) ,
    ctype_base::mask(digit | print | xdigit) ,
    ctype_base::mask(digit | print | xdigit) ,
    ctype_base::mask(digit | print | xdigit) ,
    ...
    ctype_base::mask(punct | print) ,
    ctype_base::mask(punct | print) ,
    ctype_base::mask(alpha | print | upper | xdigit) ,
    ctype_base::mask(alpha | print | upper | xdigit) ,
    ctype_base::mask(alpha | print | upper | xdigit) ,
    ctype_base::mask(alpha | print | upper | xdigit) ,
    ctype_base::mask(alpha | print | upper | xdigit) ,
    ctype_base::mask(alpha | print | upper | xdigit) ,
    ctype_base::mask(alpha | print | upper) ,
    ctype_base::mask(alpha | print | upper) ,
    ctype_base::mask(alpha | print | upper) ,
    ctype_base::mask(alpha | print | upper) ,
    ctype_base::mask(alpha | print | upper) ,
    ...
    ctype_base::mask(punct | print) ,
    ctype_base::mask(punct | print) ,
    ctype_base::mask(alpha | print | lower | xdigit) ,
    ctype_base::mask(alpha | print | lower | xdigit) ,
    ctype_base::mask(alpha | print | lower | xdigit) ,
    ctype_base::mask(alpha | print | lower | xdigit) ,
    ctype_base::mask(alpha | print | lower | xdigit) ,
    ctype_base::mask(alpha | print | lower | xdigit) ,
    ctype_base::mask(alpha | print | lower) ,
    ctype_base::mask(alpha | print | lower) ,
    ctype_base::mask(alpha | print | lower) ,
    ctype_base::mask(alpha | print | lower) ,
    ctype_base::mask(alpha | print | lower) ,
...
char
ctype<char>::do_narrow(char __c, char  ) const { return __c; }
const char*
