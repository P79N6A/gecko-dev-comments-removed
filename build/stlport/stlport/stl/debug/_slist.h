...
public:
  ...
  void merge(_Self& __x) {
    ...
    _STLP_DEBUG_CHECK(  is_sorted(_M_non_dbg_impl.begin(), _M_non_dbg_impl.end()))
    _STLP_DEBUG_CHECK(  is_sorted(__x.begin()._M_iterator, __x.end()._M_iterator))
#endif
  ...
  void merge(_Self& __x, _StrictWeakOrdering __ord) {
    ...
    _STLP_DEBUG_CHECK(  is_sorted(_M_non_dbg_impl.begin(), _M_non_dbg_impl.end(), __ord))
    _STLP_DEBUG_CHECK(  is_sorted(__x.begin()._M_iterator, __x.end()._M_iterator, __ord))
#endif
