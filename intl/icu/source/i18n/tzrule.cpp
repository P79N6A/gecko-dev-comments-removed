...
compareDates(const void * , const void *left, const void *right) {
    UDate l = *((UDate*)left);
    UDate r = *((UDate*)right);
...
UBool
InitialTimeZoneRule::getFirstStart(int32_t ,
                                  int32_t ,
                                  UDate& ) const {
    return FALSE;
}
...
UBool
InitialTimeZoneRule::getFinalStart(int32_t ,
                                  int32_t ,
                                  UDate& ) const {
    return FALSE;
}
...
UBool
InitialTimeZoneRule::getNextStart(UDate ,
                                 int32_t ,
                                 int32_t ,
                                 UBool ,
                                 UDate& ) const {
...
UBool
InitialTimeZoneRule::getPreviousStart(UDate ,
                                     int32_t ,
                                     int32_t ,
                                     UBool ,
                                     UDate& ) const {
...
const int32_t AnnualTimeZoneRule::MAX_YEAR = 0x7FFFFFFF; 
