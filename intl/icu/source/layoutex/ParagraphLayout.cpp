...
ParagraphLayout::ParagraphLayout(const LEUnicode chars[], le_int32 count,
 ...
 fVisualRunLastX(0), fVisualRunLastY(0)
{
...
static const LanguageMap languageMap[] =
{
    ...
    {"zho", zhsLanguageCode}, 
    {"zho_CHN", zhsLanguageCode}, 
    {"zho_HKG", zhsLanguageCode}, 
    {"zho_MAC", zhtLanguageCode}, 
    {"zho_SGP", zhsLanguageCode}, 
    {"zho_TWN", zhtLanguageCode}  
};
