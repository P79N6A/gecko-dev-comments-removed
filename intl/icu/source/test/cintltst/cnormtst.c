...
static void TestIsNormalized(void) {
    static const UChar notNFC[][8]={            
        { 0x62, 0x61, 0x300, 0x63, 0 },         
        { 0xfb1d, 0 },                          
        { 0x0627, 0x0653, 0 },                  
        { 0x3071, 0x306f, 0x309a, 0x3073, 0 }   
    };
    static const UChar notNFKC[][8]={           
        { 0x1100, 0x1161, 0 },                  
        { 0x1100, 0x314f, 0 },                  
        { 0x03b1, 0x1f00, 0x0345, 0x03b3, 0 }   
    };
...
enum {
    HANGUL_K_KIYEOK=0x3131,         
    HANGUL_K_WEO=0x315d,            
    HANGUL_K_KIYEOK_SIOS=0x3133,    

    HANGUL_KIYEOK=0x1100,           
    HANGUL_WEO=0x116f,              
    HANGUL_KIYEOK_SIOS=0x11aa,      

    HANGUL_AC00=0xac00,             
    HANGUL_SYLLABLE=0xac00+14*28+3, 

    MUSICAL_VOID_NOTEHEAD=0x1d157,
    MUSICAL_HALF_NOTE=0x1d15e,  
    MUSICAL_STEM=0x1d165,       
    MUSICAL_STACCATO=0x1d17c    
};
...
TestAppendRestoreMiddle() {
    UChar a[20]={ 0x61, 0x62, 0x63, 0x41, 0x327, 0 };  
    static const UChar b[]={ 0x30A, 0x64, 0x65, 0x66, 0 };  
