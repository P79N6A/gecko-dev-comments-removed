    ...
    for (rd = knownRegions; rd->code != NULL ; rd++ ) {
        ...
        if ( U_SUCCESS(status) ) {
            ...
            if ( e > 0 ) {
                ...
                if ( !uregion_areEqual(ncRegion, r) && e != 891 ) { 
...
static const char * expectPrefRegions0[] = { "AN","CW","SX","BQ",NULL };        
static const char * expectPrefRegions1[] = { "CS","RS","ME",NULL };             
static const char * expectPrefRegions2[] = { "FQ","AQ","TF",NULL };             
static const char * expectPrefRegions3[] = { "NT","IQ","SA",NULL };             
static const char * expectPrefRegions4[] = { "PC","FM","MH","MP","PW",NULL };   
static const char * expectPrefRegions5[] = { "SU","RU","AM","AZ","BY","EE","GE","KZ","KG","LV","LT","MD","TJ","TM","UA","UZ",NULL }; 
