...
static void TestCanonicalName()
{
    ...
    if (dotestconv("UTF-8", "IANA", "UTF-8") &&     
        dotestconv("UTF-8", "MIME", "UTF-8") &&     
        dotestconv("ibm-1208", "IBM", "UTF-8") &&   
        dotestconv("ibm-5305", "IBM", "UTF-8") &&   
        dotestconv("ibm-5305", "MIME", NULL) &&     
        dotestconv("ascii", "MIME", NULL) &&        
        dotestconv("ibm-1208", "IANA", NULL) &&     
        dotestconv("ibm-5305", "IANA", NULL) &&     
        dotestconv("cp1208", "", "UTF-8") &&        
        dotestconv("UTF16_BigEndian", "", "UTF-16BE") &&        
        dotestconv("ISO-2022-CN", "IANA", "ISO_2022,locale=zh,version=0") &&
        dotestconv("Shift_JIS", "MIME", "ibm-943_P15A-2003") &&
        dotestconv("Shift_JIS", "", "ibm-943_P130-1999") &&
        dotestconv("ibm-943", "", "ibm-943_P15A-2003") &&
        dotestconv("ibm-943", "IBM", "ibm-943_P130-1999") &&
        dotestconv("ibm-1363", "", "ibm-1363_P11B-1998") &&
        dotestconv("ibm-1363", "IBM", "ibm-1363_P110-1997") &&
