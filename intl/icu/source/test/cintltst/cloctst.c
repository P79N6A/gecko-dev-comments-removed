...
static void TestAcceptLanguage(void) {
    ...
    struct { 
        ...
        { 1, NULL, "en", ULOC_ACCEPT_VALID },
        { 2, NULL, "en", ULOC_ACCEPT_FALLBACK },
        { 3, NULL, "", ULOC_ACCEPT_FAILED },
        { 4, NULL, "es", ULOC_ACCEPT_VALID },
        
        { 5, NULL, "en", ULOC_ACCEPT_VALID },  
        { 6, NULL, "ja", ULOC_ACCEPT_FALLBACK },  
        { 7, NULL, "zh", ULOC_ACCEPT_FALLBACK },  
    };
