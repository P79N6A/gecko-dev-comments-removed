...
const static UChar testSourceCases[][MAX_TOKEN_LEN] = {
    {0x0041, 0x0300, 0x0301, 0x0000},
    {0x0041, 0x0300, 0x0316, 0x0000},
    {0x0041, 0x0300, 0x0000},
...
const static UChar testTargetCases[][MAX_TOKEN_LEN] = {
    {0x0041, 0x0301, 0x0300, 0x0000},
    {0x0041, 0x0316, 0x0300, 0x0000},
    {0x00C0, 0},
    {0x0041, 0x0301, 0x0300, 0x0000},
...
static void TestCase(void)
{
    ...
    {
         {0x0031 , 0x0061, 0x0000},
         {0x0031 , 0x0041, 0x0000},
         {0x2460 , 0x0061, 0x0000},
         {0x2460 , 0x0041, 0x0000}
    };
...
enum {
    SEC_COMMON_MIDDLE = 0x25,  
    TER_ONLY_COMMON_MIDDLE = 0x65  
};
...
static void TestVariableTopSetting(void) {
  ...
  static const UChar dot = 0x2e;  
  static const UChar degree = 0xb0;  
  static const UChar dollar = 0x24;  
  static const UChar zero = 0x30;  
...
#define LAST_REGULAR_CHAR_STRING "\\U0001342E"
  ...
  static const struct {
    ...
    { "&[before 3][first primary ignorable]<<<c<<<b &' '<a",  
        {  "c", "b", "\\u0332", "a" }, 4
    },
    ...
    { "&[before 3][last primary ignorable]<<<c<<<b &' '<a",  
        {  "\\u0332", "\\u20e3", "c", "b", "a" }, 5
    },
    ...
    { "&[last variable]<a &[before 3][last variable]<<<c<<<b ",
        { LAST_VARIABLE_CHAR_STRING, "c", "b",  "a", FIRST_REGULAR_CHAR_STRING }, 5
    },
    ...
    { "&[before 1][last regular]<b"
      "&[last regular]<a",
        { LAST_REGULAR_CHAR_STRING, "b",  "a", "\\u4e00" }, 4
    },
...
static void TestJ2726(void) {
    UChar a[2] = { 0x61, 0x00 }; 
    UChar aSpace[3] = { 0x61, 0x20, 0x00 }; 
    UChar spaceA[3] = { 0x20, 0x61, 0x00 }; 
    UErrorCode status = U_ZERO_ERROR;
...
static void TestNumericCollation(void)
{
    ...
    "", 
    ...
    "", 
    "", 
    "", 
    "", 
...
static int32_t checkUEnumeration(const char* msg,
    ...
    U_ASSERT(expectedCount >= 0 && expectedCount < 31); 
...
TestVI5913(void)
{
    ...
    UChar rule[256]={0x26, 0x62, 0x3c, 0x1FF3, 0};  
    UChar rule2[256]={0x26, 0x7a, 0x3c, 0x0161, 0};  
    ...
    UChar rule3[256]={
        0x26, 0x78, 0x3c, 0x61, 0x65,      
        0x26, 0x7a, 0x3c, 0x0061, 0x00ea,  
        0};
    ...
    static const UChar tailorData3[][20]={
        ...
        {0x0061, 0x00ea, 0}, 
        {0x0061, 0x1EC7, 0},  
        {0x0061, 0x1EB9, 0x0302, 0}, 
        {0x0061, 0x00EA, 0x0323, 0},  
        {0x00EA, 0x0323, 0},  
        {0x00EA, 0},  
    };
...
TestUCAPrecontext(void)
{
    ...
    int32_t  rLen, tLen, ruleLen;
    UChar rule1[256]= {0x26, 0xb7, 0x3c, 0x61, 0}; 
...
const static OneTestCase rangeTestcases[] = {
  { {0x0061},                            {0x0062},                          UCOL_LESS }, 
  { {0x0062},                            {0x0063},                          UCOL_LESS }, 
  { {0x0061},                            {0x0063},                          UCOL_LESS }, 

  { {0x0062},                            {0x006b},                          UCOL_LESS }, 
  { {0x006b},                            {0x006c},                          UCOL_LESS }, 
  { {0x0062},                            {0x006c},                          UCOL_LESS }, 
  { {0x0061},                            {0x006c},                          UCOL_LESS }, 
  { {0x0061},                            {0x006d},                          UCOL_LESS },  

  { {0x0079},                            {0x006d},                          UCOL_LESS },  
  { {0x0079},                            {0x0067},                          UCOL_LESS },  
  { {0x0061},                            {0x0068},                          UCOL_LESS },  
  { {0x0061},                            {0x0065},                          UCOL_LESS },  

  { {0x0061},                            {0x0031},                          UCOL_EQUAL }, 
  { {0x0061},                            {0x0032},                          UCOL_EQUAL }, 
  { {0x0061},                            {0x0033},                          UCOL_EQUAL }, 
  { {0x0061},                            {0x0066},                          UCOL_LESS }, 
  { {0x006c, 0x0061},                    {0x006b, 0x0062},                  UCOL_LESS },  
  { {0x0061, 0x0061, 0x0061},            {0x0031, 0x0032, 0x0033},          UCOL_EQUAL }, 
  { {0x0062},                            {0x007a},                          UCOL_LESS },  
  { {0x0061, 0x007a, 0x0062},            {0x0032, 0x0079, 0x006d},          UCOL_LESS }, 
};

static int nRangeTestcases = LEN(rangeTestcases);

const static OneTestCase rangeTestcasesSupplemental[] = {
  { {0x4e00},                            {0xfffb},                          UCOL_LESS }, 
  { {0xfffb},                            {0xd800, 0xdc00},                  UCOL_LESS }, 
  { {0xd800, 0xdc00},                    {0xd800, 0xdc01},                  UCOL_LESS }, 
  { {0x4e00},                            {0xd800, 0xdc01},                  UCOL_LESS }, 
  { {0xd800, 0xdc01},                    {0xd800, 0xdc02},                  UCOL_LESS }, 
  { {0xd800, 0xdc01},                    {0xd800, 0xdc02},                  UCOL_LESS }, 
  { {0x4e00},                            {0xd800, 0xdc02},                  UCOL_LESS }, 
};

static int nRangeTestcasesSupplemental = LEN(rangeTestcasesSupplemental);

const static OneTestCase rangeTestcasesQwerty[] = {
  { {0x0071},                            {0x0077},                          UCOL_LESS }, 
  { {0x0077},                            {0x0065},                          UCOL_LESS }, 

  { {0x0079},                            {0x0075},                          UCOL_LESS }, 
  { {0x0071},                            {0x0075},                          UCOL_LESS }, 

  { {0x0074},                            {0x0069},                          UCOL_LESS }, 
  { {0x006f},                            {0x0070},                          UCOL_LESS }, 

  { {0x0079},                            {0x0065},                          UCOL_LESS },  
  { {0x0069},                            {0x0075},                          UCOL_LESS },  

  { {0x0071, 0x0075, 0x0065, 0x0073, 0x0074},
    {0x0077, 0x0065, 0x0072, 0x0065},                                       UCOL_LESS }, 
  { {0x0071, 0x0075, 0x0061, 0x0063, 0x006b},
    {0x0071, 0x0075, 0x0065, 0x0073, 0x0074},                               UCOL_LESS }, 
};
...
static const UChar longUpperStr1[]= { 
...
static const UChar longUpperStr2[]= { 
...
static const UChar longUpperStr3[]= { 
...
static const UChar testJapaneseName[] = {0x4F50, 0x3005, 0x6728, 0x002C, 0x6B66, 0}; 
