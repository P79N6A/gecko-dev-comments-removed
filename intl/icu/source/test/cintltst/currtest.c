...
static void TestEnumList(void) {
    expectInList("ADP", UCURR_ALL, TRUE); 
    expectInList("ZWD", UCURR_ALL, TRUE); 
...
static void TestFractionDigitOverride(void) {
    ...
    const char expectedFirst[] = "123,46\\u00A0HUF"; 
...
static void TestPrefixSuffix(void) {
    ...
    UChar buffer[4];
    static const UChar TEST_NUMBER[] = {0x0024,0x0031,0x0032,0x002E,0x0030,0x0030,0}; 
