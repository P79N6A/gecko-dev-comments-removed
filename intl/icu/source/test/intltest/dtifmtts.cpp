...
void DateIntervalFormatTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  ) {
...
void DateIntervalFormatTest::testAPI() {
    ...
    if ( U_SUCCESS(status) ) {
        UDate date1 = 1299090600000.0; 
        UDate date2 = 1299115800000.0; 
...
void DateIntervalFormatTest::testFormat() {
    ...
    const char* DATA[] = {
        ...
        "zh", "2007 11 10 10:10:10", "2007 11 20 10:10:10", "MMMMy", "2007\\u5E7411\\u6708", 
        ...
        "zh", "2007 11 10 10:10:10", "2007 11 20 10:10:10", "y", "2007\\u5E74", 
...
void DateIntervalFormatTest::testFormatUserDII() {
    ...
    const char* DATA[] = {
        ...
        "zh", "2007 01 10 10:00:10", "2007 01 10 14:10:10", "2007\\u5e741\\u670810\\u65e5", 
        
        "zh", "2007 01 10 10:00:10", "2007 01 10 10:20:10", "2007\\u5e741\\u670810\\u65e5", 
        
        "zh", "2007 01 10 10:10:10", "2007 01 10 10:10:20", "2007\\u5e741\\u670810\\u65e5", 
