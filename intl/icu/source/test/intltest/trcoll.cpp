...
void CollationTurkishTest::TestTertiary()
{
    int32_t i = 0;
...
void CollationTurkishTest::TestPrimary()
{
    int32_t i;
...
void CollationTurkishTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
