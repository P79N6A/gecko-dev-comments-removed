...
void CollationIteratorTest::TestPrevious()
{
...
void CollationIteratorTest::TestSetText()
{
...
void CollationIteratorTest::TestMaxExpansion()
{
    UErrorCode          status = U_ZERO_ERROR; 
...
void CollationIteratorTest::TestClearBuffers()
{
    UErrorCode status = U_ZERO_ERROR;
...
void CollationIteratorTest::runIndexedTest(int32_t index, UBool exec, const char* &name, char* )
{
    if (exec)
    {
    ...
    if(en_us) {
      switch (index)
      {
          case  0: name = "TestPrevious";      if (exec) TestPrevious();     break;
          case  1: name = "TestOffset";        if (exec) TestOffset();       break;
          case  2: name = "TestSetText";       if (exec) TestSetText();      break;
          case  3: name = "TestMaxExpansion";  if (exec) TestMaxExpansion(); break;
          case  4: name = "TestClearBuffers";  if (exec) TestClearBuffers(); break;
          case  5: name = "TestUnicodeChar";   if (exec) TestUnicodeChar();  break;
          case  6: name = "TestAssignment";    if (exec) TestAssignment();    break;
          case  7: name = "TestConstructors";  if (exec) TestConstructors(); break;
          case  8: name = "TestStrengthOrder"; if (exec) TestStrengthOrder(); break;
          default: name = ""; break;
      }
    } else {
