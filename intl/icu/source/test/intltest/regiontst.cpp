...
void RegionTest::TestGetInstanceString() {
    ...
    static TestData testData[] = {
        ...
        { "DE", "DE", URGN_TERRITORY },  
        { "QU", "EU", URGN_GROUPING },   
        { "DD", "DE", URGN_TERRITORY },  
        { "276", "DE", URGN_TERRITORY }, 
        { "278", "DE", URGN_TERRITORY }, 
        { "SU", "SU", URGN_DEPRECATED }, 
        { "AN", "AN", URGN_DEPRECATED }, 
        { "SVK", "SK", URGN_TERRITORY }  
    };
...
void RegionTest::TestGetInstanceInt() {
    ...
    static TestData testData[] = {
        ...
        { 276, "DE",  URGN_TERRITORY }, 
        { 278, "DE",  URGN_TERRITORY }, 
        { 419, "419", URGN_GROUPING },  
        { 736, "SD",  URGN_TERRITORY }, 
        { 729, "SD",  URGN_TERRITORY }, 
    };
...
void RegionTest::TestGetPreferredValues() {
    static const char *testData[6][17] = {
        ...
        { "AN", "CW", "SX", "BQ", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL }, 
        { "CS", "RS", "ME", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL },     
        { "FQ", "AQ", "TF", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL },     
        { "NT", "IQ", "SA", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL },     
        { "PC", "FM", "MH", "MP", "PW", NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, }, 
        { "SU", "RU", "AM", "AZ", "BY", "EE", "GE", "KZ", "KG", "LV", "LT", "MD", "TJ", "TM", "UA", "UZ" , NULL}, 
    };
