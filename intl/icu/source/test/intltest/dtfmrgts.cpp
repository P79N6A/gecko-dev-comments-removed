...
void 
DateFormatRegressionTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
...
DateFormatRegressionTest::Test4162071(void) 
{
    ...
    UnicodeString format("EEE', 'dd-MMM-yyyy HH:mm:ss z"); 
    UErrorCode status = U_ZERO_ERROR;
...
DateFormatRegressionTest::Test4210209(void) {
    ...
    DateFormat& fmt = *(DateFormat*)&sfmt; 
    DateFormat& disp = *(DateFormat*)&sdisp; 
    if (U_FAILURE(status)) {
        dataerrln("Couldn't create SimpleDateFormat - %s", u_errorName(status));
        return;
    }
    Calendar* calx = (Calendar*)fmt.getCalendar(); 
...
void DateFormatRegressionTest::Test1684(void)
{
  ...
  Test1684Data *tests[] = {
    ...
    new Test1684Data(2001, 8,  5, 2001,8,2,UCAL_SUNDAY,    "2001 08 02 Sun", NULL),
    new Test1684Data(2001, 8,6,  2001,7,6,UCAL_MONDAY,    "2001 07 06 Mon", "2001 08 02 Mon"),
    new Test1684Data(2001, 8,7,  2001,7,6,UCAL_TUESDAY,   "2001 07 06 Tue", "2001 08 02 Tue"),
    ...
    new Test1684Data(2001, 7,29,   2001,8,1,UCAL_SUNDAY,    "2001 08 01 Sun", "2001 07 05 Sun"),
    ...
    new Test1684Data(2001,12,30,   2002,1,1,UCAL_SUNDAY,    "2002 01 01 Sun", "2001 12 06 Sun")
  };
...
void DateFormatRegressionTest::Test9237(void)
{
    ...
    SimpleDateFormat fmt(pattern, status);  
