...
void CollationGermanTest::TestTertiary()
{
    if(myCollation == NULL ) {
...
void CollationGermanTest::TestPrimary()
{
    if(myCollation == NULL ) {
        dataerrln("decoll: cannot start test, collator is null\n");
        return;
...
void CollationGermanTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
