...
void IntlTestNumberFormat::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
    ...
    switch (index) {
        ...
        case 1: name = "DefaultLocale";
            if (exec) testLocale(Locale::getDefault(), name);
            break;
...
void
IntlTestNumberFormat::testLocale(const Locale& locale, const UnicodeString& localeName)
{
    const char* name;
...
void
IntlTestNumberFormat::testFormat()
{
...
void IntlTestNumberFormat::testAvailableLocales()
{
    int32_t count = 0;
...
void IntlTestNumberFormat::monsterTest()
{
    const char *SEP = "============================================================\n";
    int32_t count;
