...
JamoTest::TestJamo() {
    ...
    static const char* CASE[] = {
        ...
        "gabsbka", "(Gi)(A)(BS)(Bi)(EU)(Ki)(A)", "gabsbeuka", 
...
void JamoTest::TestPiecemeal(void) {
    ...
    t = Transliterator::createInstance("NFD", UTRANS_FORWARD, status); 
    ...
    t = Transliterator::createInstance("NFC", UTRANS_FORWARD, status); 
    if (U_FAILURE(status) || t == 0) {
