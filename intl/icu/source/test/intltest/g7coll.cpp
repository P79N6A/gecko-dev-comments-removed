...
void G7CollationTest::TestG7Locales()
{
    int32_t i;
...
void G7CollationTest::TestDemo1()
{
...
void G7CollationTest::TestDemo2()
{
...
void G7CollationTest::TestDemo3()
{
...
void G7CollationTest::TestDemo4()
{
...
void G7CollationTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
    if (exec) logln("TestSuite G7CollationTest: ");
    switch (index) {
        case 0: name = "TestG7Locales"; if (exec)   TestG7Locales(); break;
        case 1: name = "TestDemo1"; if (exec)   TestDemo1(); break;
        case 2: name = "TestDemo2"; if (exec)   TestDemo2(); break;
        case 3: name = "TestDemo3"; if (exec)   TestDemo3(); break;
        case 4: name = "TestDemo4"; if (exec)   TestDemo4(); break;
        default: name = ""; break;
    }
}
