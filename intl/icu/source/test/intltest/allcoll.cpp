...
void CollationDummyTest::TestTertiary()
{
    int32_t i = 0;
...
void CollationDummyTest::TestPrimary()
{
...
void CollationDummyTest::TestSecondary()
{
    int32_t i;
...
void CollationDummyTest::TestExtra()
{
    int32_t i, j;
    myCollation->setStrength(Collator::TERTIARY);
...
void CollationDummyTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
    ...
    if(myCollation) {
      switch (index) {
          ...
          case 3: name = "TestExtra";     if (exec)   TestExtra(); break;
          case 4: name = "TestIdentical"; if (exec)   TestIdentical(); break;
          case 5: name = "TestJB581";     if (exec)   TestJB581(); break;
          default: name = ""; break;
      }
    } else {
