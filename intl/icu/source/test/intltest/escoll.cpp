...
void CollationSpanishTest::TestTertiary()
{
    int32_t i = 0;
...
void CollationSpanishTest::TestPrimary()
{
    int32_t i;
...
void CollationSpanishTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char* )
{
