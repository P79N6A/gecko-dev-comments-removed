...
void
CollationAPITest::TestCollationKey()
{
...
void
CollationAPITest::TestOperators()
{
    UErrorCode success = U_ZERO_ERROR;
    UnicodeString ruleset1("&9 < a, A < b, B < c, C; ch, cH, Ch, CH < d, D, e, E");
    UnicodeString ruleset2("&9 < a, A < b, B < c, C < d, D, e, E");
...
void 
CollationAPITest::TestDuplicate()
{
    UErrorCode status = U_ZERO_ERROR;
...
void TestCollator::setAttribute(UColAttribute , UColAttributeValue , 
                                UErrorCode & )
{
}
...
void CollationAPITest::TestSubclass()
{
    ...
    col1.setLocales(loc1, loc2, loc2); 

    UnicodeString displayName;
    col1.getDisplayName(loc1, loc2, displayName); 
...
void CollationAPITest::runIndexedTest( int32_t index, UBool exec, const char* &name, char* )
{
