...
void PluralRulesTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
...
void setupResult(const int32_t testSource[], char result[], int32_t* max) {
    ...
    do {
        while (curIndex < testSource[i]) {
            result[curIndex++]=0x6F; 
        }
        result[curIndex++]=0x61; 
...
void PluralRulesTest::testGetUniqueKeywordValue() {
  ...
  assertRuleKeyValue("a: n is 1", "not_defined", UPLRULES_NO_UNIQUE_VALUE); 
  assertRuleKeyValue("a: n is 1", "other", UPLRULES_NO_UNIQUE_VALUE); 
}
...
PluralRulesTest::testGetAllKeywordValues() {
    const char* data[] = {
        ...
        "a: n in 2..5 or n within 6..8", "a: null", 
        "a: n in 2..5 and n within 6..8", "a:",
        "a: n in 2..5 and n within 5..8", "a: 5",
        "a: n within 2..5 and n within 6..8", "a:", 
...
static const char * END_MARK = "999.999";    
