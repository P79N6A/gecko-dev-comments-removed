...
void SelectFormatTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
...
void SelectFormatTest::selectFormatUnitTest()
{
  const UnicodeString SIMPLE_PATTERN(SIMPLE_PATTERN_STRING); 
...
void SelectFormatTest::selectFormatAPITest()
{
  const UnicodeString SIMPLE_PATTERN(SIMPLE_PATTERN_STRING); 
