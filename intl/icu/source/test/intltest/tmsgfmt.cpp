...
void TestMessageFormat::testBug3()
{
    ...
    for (i= 0; i < 49; i++) {
        ...
        logln(UnicodeString(" -> ")  + toString(result) + UnicodeString("[supposed output for result]"));
        if (U_FAILURE(success)) {
...
void TestMessageFormat::testSimpleFormat()
{
...
void TestMessageFormat::testMsgFormatChoice()
{
...
void TestMessageFormat::testMsgFormatPlural()
{
...
void TestMessageFormat::testMsgFormatSelect()
{
...
void TestMessageFormat::testAdopt()
{
    ...
    msg.applyPattern( formatStrChange, err ); 
    int32_t countChg;
    formatsChg = msg.getFormats(countChg); 
    ...
    msg.setFormats( formatsCmp, countCmp ); 
    ...
    msg.adoptFormats( formatsToAdopt, countCmp ); 
    ...
    for ( i = 0; i < countCmp; i++ ) {
        msg.adoptFormat( i, formatsToAdopt[i] ); 
    }
    delete[] formatsToAdopt; 
