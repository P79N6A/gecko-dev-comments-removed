...
{       
    ...
    for (int32_t h=0; h<25; ++h) {
        ...
        logln(UnicodeString("HOUR=") + cal->get(UCAL_HOUR, status)); 
...
void CalendarRegressionTest::test4071385() 
{
    ...
    cal->set(UCAL_MONTH, UCAL_NOVEMBER); 
...
void CalendarRegressionTest::test4147269() 
{
    ...
    UDate date = makeDate(1996, UCAL_JANUARY, 3); 
...
CalendarRegressionTest::Test4167060() 
{
    ...
    GregorianCalendar *calendars [] = {
        ...
        new GregorianCalendar(-99 , UCAL_JANUARY, 1, status),
    ...
    for (int32_t k=0; k<3; ++k) {
        ...
        for (int32_t j=0; j < 3; ++j) {
            ...
            for (int32_t i = 0; i < 4; i++) {
                ...
                calendar->setTime(dateBefore, status); 
                if(U_FAILURE(status))
                    errln("setTime() failed");
                ...
                else if (!valid &&  dateAfter + 1.0 == dateAfter)  {
...
static const CoptEthCalTestItem coptEthCalTestItems[] = {
    ...
    { 1723, 12, 2, UCAL_MONTH, +1, 1724,  0, 2 }, 
    ...
    { 1723, 12, 1, UCAL_DATE,  +8, 1724,  0, 3 }, 
    { 1724,  0, 1, UCAL_DATE,  -1, 1723, 12, 6 }, 
    { 0, 0, 0, (UCalendarDateFields)0, 0, 0, 0, 0 } 
};
...
void CalendarRegressionTest::TestLeapFieldDifference() {
    ...
    cal->set(2001, UCAL_APRIL, 5); 
    UDate ayl = cal->getTime(ec);
    cal->set(1964, UCAL_SEPTEMBER, 7); 
...
void CalendarRegressionTest::TestWeekShift() {
    ...
    cal.setTime(UDate(997257600000.0), ec); 
...
void CalendarRegressionTest::TestT8057(void) {
    ...
    UDate expected = 1262246400000.0; 
