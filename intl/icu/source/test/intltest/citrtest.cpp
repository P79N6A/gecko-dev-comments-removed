...
public:
    ...
    virtual UBool operator==(const ForwardCharacterIterator& ) const{
        return TRUE;
    }
    ...
    virtual UChar setIndex(int32_t ){return DONE;};
    virtual UChar32 setIndex32(int32_t ){return DONE;};
...
void CharIterTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
...
public:
    ...
    virtual int32_t move(int32_t , EOrigin ) {
        return 0;
    }
