...
void IntlTestDateTimePatternGeneratorAPI::testAPI()
{
    ...
    UnicodeString patternResults[] = {
        ...
        UnicodeString("1/1999"),                              
        UnicodeString("Jan 1999"),                            
        UnicodeString("1/13/1999"),                           
        UnicodeString("Jan 13, 1999"),                        
        UnicodeString("1/13"),                                
        UnicodeString("Jan 13"),                              
        UnicodeString("January 13"),                          
        UnicodeString("Q1 1999"),                             
        UnicodeString("11:58 PM"),                            
        UnicodeString("23:58"),                               
        UnicodeString("11:58 PM"),                            
        UnicodeString("58:59"),                               
        UnicodeString("January 1999"),                        
        UnicodeString("Wed, Jan 13"),                         
        UnicodeString("13 Wed"),                              
        UnicodeString("11:58:59.123 PM"),                     
        UnicodeString("11:58"),                               

        
        UnicodeString("1/11 H"),                              
        UnicodeString("Jan 11 Heisei"),                       
        UnicodeString("1/13/11 H"),                           
        UnicodeString("Jan 13, 11 Heisei"),                   
        UnicodeString("1/13"),                                
        UnicodeString("Jan 13"),                              
        UnicodeString("January 13"),                          
        UnicodeString("Q1 11 Heisei"),                        
        UnicodeString("11:58 PM"),                            
        UnicodeString("23:58"),                               
        UnicodeString("11:58 PM"),                            
        UnicodeString("58:59"),                               
        UnicodeString("January 11 Heisei"),                   
        UnicodeString("Wed, Jan 13"),                         
        UnicodeString("13 Wed"),                              
        UnicodeString("11:58:59.123 PM"),                     
        UnicodeString("11:58"),                               
        ...
        UnicodeString("13. Januar"),                          
        UnicodeString("Q1 1999"),                             
        UnicodeString("11:58 nachm."),                        
        UnicodeString("23:58"),                               
        UnicodeString("23:58"),                               
        UnicodeString("58:59"),                               
        UnicodeString("Januar 1999"),                         
        UnicodeString("Mi., 13. Jan."),                       
        UnicodeString("Mi., 13."),                            
        UnicodeString("23:58:59,123"),                        
        UnicodeString("23:58"),                               
        ...
        UnicodeString("11.58 ip."),                           
        UnicodeString("23.58"),                               
        UnicodeString("23.58"),                               
        UnicodeString("58.59"),                               
        UnicodeString("tammikuu 1999"),                       
        UnicodeString("ke 13. tammikuuta"),                   
        UnicodeString("ke 13."),                              
        UnicodeString("23.58.59,123"),                        
        UnicodeString("23.58"),                               
        ...
        UnicodeString("1/1999"),                              
        UnicodeString("ene. 1999"),                           
        UnicodeString("13/1/1999"),                           
        UnicodeString("13 ene. 1999"),                        
        UnicodeString("13/1"),                                
        UnicodeString("13 ene."),                             
        UnicodeString("13 de enero"),                         
        UnicodeString("T1 1999"),                             
        UnicodeString("11:58 p. m."),                         
        UnicodeString("23:58"),                               
        UnicodeString("23:58"),                               
        UnicodeString("58:59"),                               
        UnicodeString("enero de 1999"),                       
        CharsToUnicodeString("mi\\u00E9., 13 ene."),          
        CharsToUnicodeString("mi\\u00E9. 13"),                
        UnicodeString("23:58:59,123"),                        
        UnicodeString("23:58"),                               

        
        UnicodeString("1999/1"),                                          
        CharsToUnicodeString("1999\\u5E741\\u6708"),                      
        UnicodeString("1999/1/13"),                                       
        CharsToUnicodeString("1999\\u5E741\\u670813\\u65E5"),             
        UnicodeString("1/13"),                                            
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("1999/Q1"),                                  
        CharsToUnicodeString("\\u5348\\u5F8C11:58"),                      
        UnicodeString("23:58"),                                           
        UnicodeString("23:58"),                                           
        UnicodeString("58:59"),                                           
        CharsToUnicodeString("1999\\u5E741\\u6708"),                      
        CharsToUnicodeString("1\\u670813\\u65E5(\\u6C34)"),               
        CharsToUnicodeString("13\\u65E5(\\u6C34)"),                       
        UnicodeString("23:58:59.123"),                                    
        UnicodeString("23:58"),                                           

        
        CharsToUnicodeString("\\u5E73\\u621011/1"),                       
        CharsToUnicodeString("\\u5E73\\u621011\\u5E741\\u6708"),          
        CharsToUnicodeString("\\u5E73\\u621011/1/13"),                    
        CharsToUnicodeString("\\u5E73\\u621011\\u5E741\\u670813\\u65E5"), 
        UnicodeString("1/13"),                                            
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("\\u5E73\\u621011/Q1"),                     
        CharsToUnicodeString("\\u5348\\u5F8C11:58"),                      
        UnicodeString("23:58"),                                           
        UnicodeString("23:58"),                                           
        UnicodeString("58:59"),                                           
        ...
        CharsToUnicodeString("1999\\u5E741\\u6708"),                      
        CharsToUnicodeString("1999\\u5E741\\u6708"),                      
        CharsToUnicodeString("1999/1/13"),                                
        CharsToUnicodeString("1999\\u5E741\\u670813\\u65E5"),             
        UnicodeString("1/13"),                                            
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("1999\\u5E74\\u7B2C1\\u5B63\\u5EA6"),        
        CharsToUnicodeString("\\u4E0B\\u534811:58"),                      
        UnicodeString("23:58"),                                           
        CharsToUnicodeString("\\u4E0B\\u534811:58"),                      
        UnicodeString("58:59"),                                           
        CharsToUnicodeString("1999\\u5E741\\u6708"),                      
        CharsToUnicodeString("1\\u670813\\u65E5\\u5468\\u4E09"),          
        CharsToUnicodeString("13\\u65E5\\u5468\\u4E09"),                  
        CharsToUnicodeString("\\u4E0B\\u534811:58:59.123"),               
        UnicodeString("11:58"),                                           

        
        CharsToUnicodeString("\\u6C11\\u570B88/1"),                       
        CharsToUnicodeString("\\u6C11\\u570B88\\u5E741\\u6708"),          
        CharsToUnicodeString("\\u6C11\\u570B88/1/13"),                    
        CharsToUnicodeString("\\u6C11\\u570B88\\u5E741\\u670813\\u65E5"), 
        UnicodeString("1/13"),                                            
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("1\\u670813\\u65E5"),                        
        CharsToUnicodeString("\\u6C11\\u570B88\\u5E741\\u5B63"),          
        CharsToUnicodeString("\\u4E0B\\u534811:58"),                      
        UnicodeString("23:58"),                                           
        CharsToUnicodeString("\\u4E0B\\u534811:58"),                      
        UnicodeString("58:59"),                                           
        CharsToUnicodeString("\\u6C11\\u570B88\\u5E741\\u6708"),          
        CharsToUnicodeString("1\\u670813\\u65E5\\u9031\\u4E09"),          
        CharsToUnicodeString("13\\u65E5\\uff08\\u9031\\u4E09\\uff09"),    
        CharsToUnicodeString("\\u4E0B\\u534811:58:59.123"),               
        UnicodeString("11:58"),                                           
        ...
        UnicodeString("13.01.1999"),                                      
        CharsToUnicodeString("13 \\u044F\\u043D\\u0432. 1999 \\u0433."),  
        UnicodeString("13.01"),                                           
        CharsToUnicodeString("13 \\u044F\\u043D\\u0432."),                
        CharsToUnicodeString("13 \\u044F\\u043D\\u0432\\u0430\\u0440\\u044F"), 
        CharsToUnicodeString("1-\\u0439 \\u043A\\u0432. 1999 \\u0433."),  
        UnicodeString("11:58 PM"),                                        
        UnicodeString("23:58"),                                           
        UnicodeString("23:58"),                                           
        UnicodeString("58:59"),                                           
        CharsToUnicodeString("\\u044F\\u043D\\u0432\\u0430\\u0440\\u044C 1999"), 
        CharsToUnicodeString("\\u0421\\u0440, 13 \\u044F\\u043D\\u0432."), 
        CharsToUnicodeString("\\u0421\\u0440, 13"),                       
        UnicodeString("23:58:59,123"),                                    
        UnicodeString("23:58"),                                           

        
        CharsToUnicodeString("1998\\u620A\\u5BC5\\u5E74\\u51AC\\u6708"),  
        CharsToUnicodeString("1998\\u620A\\u5BC5\\u5E74\\u51AC\\u6708"),  
        CharsToUnicodeString("1998\\u5E74\\u51AC\\u670826"),              
        CharsToUnicodeString("1998\\u5E74\\u51AC\\u670826"),              
        UnicodeString("11-26"),                                           
        CharsToUnicodeString("\\u51AC\\u670826\\u65E5"),                  
        CharsToUnicodeString("\\u51AC\\u670826\\u65E5"),                  
        CharsToUnicodeString("1998\\u620A\\u5BC5\\u5E74\\u7b2c\\u56db\\u5B63\\u5EA6"),  
        CharsToUnicodeString("\\u4E0B\\u534811:58"),                      
        UnicodeString("23:58"),                                           
        CharsToUnicodeString("\\u4E0B\\u534811:58"),                      
        UnicodeString("58:59"),                                           
        CharsToUnicodeString("1998\\u620A\\u5BC5\\u5E74\\u51AC\\u6708"),  
        CharsToUnicodeString("\\u51AC\\u670826\\u65E5\\u5468\\u4E09"),    
        CharsToUnicodeString("26\\u65E5\\u5468\\u4E09"),                  
        CharsToUnicodeString("\\u4E0B\\u534811:58:59.123"),               
        UnicodeString("11:58"),                                           
    ...
    
    {
        ...
        UnicodeString expR = CharsToUnicodeString("1999\\u5E741\\u6708"); 
        Locale loc("ja");
...

    {
         ...
         UnicodeString expR = UnicodeString("h:mm a v"); 
         Locale loc("en");
         DateTimePatternGenerator *patGen=DateTimePatternGenerator::createInstance(loc, status);
         if(U_FAILURE(status)) {
             dataerrln("ERROR: Could not create DateTimePatternGenerator");
    ...
    conflictingStatus = test->addPattern(UnicodeString("MMMMMdd"), true, conflictingPattern, status); 
...
void IntlTestDateTimePatternGeneratorAPI::testOptions()
{
    DTPtnGenOptionsData testData[] = {
        ...
        { "en@calendar=chinese",  "YYYY",  "Y(Y)",  UDATPG_MATCH_NO_OPTIONS }, 
        ...
        { "zh@calendar=chinese",  "YYYY",  "YY\\u5E74",    UDATPG_MATCH_NO_OPTIONS }, 
...
typedef struct AllFieldsTestItem {
    char patternChar;
    int8_t fieldLengths[FIELD_LENGTHS_COUNT+1]; 
                                                
    char mustIncludeOneOf[MUST_INCLUDE_COUNT+1];
