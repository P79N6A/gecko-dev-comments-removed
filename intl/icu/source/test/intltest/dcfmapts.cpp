...
void IntlTestDecimalFormatAPI::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
...
void IntlTestDecimalFormatAPI::testAPI()
{
    UErrorCode status = U_ZERO_ERROR;
...
void IntlTestDecimalFormatAPI::testRounding()
{
    UErrorCode status = U_ZERO_ERROR;
...
void IntlTestDecimalFormatAPI::testRoundingInc()
{
    UErrorCode status = U_ZERO_ERROR;
