...
static const UChar EUR[] = {69,85,82,0}; 
...
void NumberFormatTest::TestCurrencyObject() {
    ...
    expectCurrency(*fmt, Locale::getJapan(),
                   1234.56, CharsToUnicodeString("1 235 JPY")); 

    expectCurrency(*fmt, Locale("fr", "CH", ""),
                   1234.56, "1 234,56 CHF"); 
...
void NumberFormatTest::TestCurrencyUnit(void){
    ...
    const UChar * r = cu.getISOCurrency(); 
...
void NumberFormatTest::TestJB3832(){
    ...
    Locale loc(localeID);
    UErrorCode status = U_ZERO_ERROR;
    UnicodeString expected(CharsToUnicodeString("1,150$50\\u00A0\\u200B")); 
    UnicodeString s;
...
void NumberFormatTest::TestNumberingSystems() {
    ...
    const TestNumberingSystemItem DATA[] = {
        ...
        { "th_TH@numbers=traditional", 1234.567, FALSE, "\\u0E51,\\u0E52\\u0E53\\u0E54.\\u0E55\\u0E56\\u0E57" }, 
        ...
        { "ta_IN@numbers=finance", 1234.567, FALSE, "1,234.567" }, 
...
void NumberFormatTest::TestDecimal() {
...

    {
        ...
        status = U_ZERO_ERROR;
        f.setDecimalNumber("1234567890123", status);  
        ASSERT_SUCCESS(status);
...
void NumberFormatTest::TestFormatFastpaths() {
    ...
    }
    {
        ...
        int64_t long_number = U_INT64_MIN; 
    ...
    }
    {
        UErrorCode status=U_ZERO_ERROR;
        DecimalFormat df(UnicodeString("0000000000000000000",""),status);
        int64_t long_number = U_INT64_MAX; 
...
UBool NumberFormatTest::testFormattableAsUFormattable(const char *file, int line, Formattable &f) {
  ...
  UFormattableType expectUType = UFMT_COUNT; 

  UBool triedExact = FALSE; 
  UBool exactMatch = FALSE; 
...
void NumberFormatTest::TestUFormattable(void) {
  ...
  {
    Formattable f((double)1.61803398874989484820); 
    testFormattableAsUFormattable(__FILE__, __LINE__,  f);
  }
  {
    Formattable f((int64_t)80994231587905127LL); 
    testFormattableAsUFormattable(__FILE__, __LINE__,  f);
  }
  {
    Formattable f((int32_t)4); 
    testFormattableAsUFormattable(__FILE__, __LINE__,  f);
  }
  {
    Formattable f("Hello world."); 
    testFormattableAsUFormattable(__FILE__, __LINE__,  f);
  }
  {
    UErrorCode status2 = U_ZERO_ERROR;
    Formattable f(StringPiece("73476730924573500000000.0"), status2); 
