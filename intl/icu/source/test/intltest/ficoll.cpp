...
void CollationFinnishTest::TestTertiary()
{
    int32_t i = 0;
...
void CollationFinnishTest::TestPrimary()
{
    int32_t i;
...
void CollationFinnishTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
