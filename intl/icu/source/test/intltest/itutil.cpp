...
void ErrorCodeTest::runIndexedTest(int32_t index, UBool exec, const char* &name, char* ) {
    if (exec) logln("TestSuite Utilities: ");
    switch (index) {
...
void LocalPointerTest::runIndexedTest(int32_t index, UBool exec, const char *&name, char * ) {
    if(exec) {
...
void EnumSetTest::runIndexedTest(int32_t index, UBool exec, const char *&name, char * ) {
  TESTCASE_AUTO_BEGIN;
