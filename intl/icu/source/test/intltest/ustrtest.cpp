...
UnicodeStringTest::TestCompare()
{
    ...
    
    {
        ...
        static const UChar strings[][4]={
            { 0x61, 0 },                    
            { 0x20ac, 0xd801, 0 },          
            { 0x20ac, 0xd800, 0xdc00, 0 },  
            { 0xd800, 0 },                  
            { 0xd800, 0xff61, 0 },          
            { 0xdfff, 0 },                  
            { 0xff61, 0xdfff, 0 },          
            { 0xff61, 0xd800, 0xdc02, 0 },  
            { 0xd800, 0xdc02, 0 },          
            { 0xd84d, 0xdc56, 0 }           
        };
        UnicodeString u[20]; 
...
namespace bogus {
    ...
    public:
        ...
        UnicodeString() : i(1) {}
        UnicodeString(UBool , const UChar * , int32_t textLength) : i(textLength) {(void)i;}
        UnicodeString(const char * , int32_t length, enum EInvariant 
) : i(length) {}
    private:
        int32_t i;
    };
