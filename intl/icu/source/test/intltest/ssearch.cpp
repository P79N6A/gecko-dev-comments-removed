...
void SSearchTest::goodSuffixTest()
{
    UErrorCode status = U_ZERO_ERROR;
    UCollator *coll = NULL;
    UnicodeString pat =  "fxeld";
    UnicodeString target =  "cloveldfxeld";
    int32_t start = -1, end = -1;
    UBool bFound;
