...
static const UChar ETC_SLASH[] = { 0x45, 0x74, 0x63, 0x2F, 0 }; 
static const UChar SYSTEMV_SLASH[] = { 0x53, 0x79, 0x73, 0x74, 0x65, 0x6D, 0x56, 0x2F, 0 }; 
static const UChar RIYADH8[] = { 0x52, 0x69, 0x79, 0x61, 0x64, 0x68, 0x38, 0 }; 
...
void
TimeZoneFormatTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
    if (exec) {
...
TimeZoneFormatTest::TestFormat(void) {
    UDate dateJan = 1358208000000.0;    
    UDate dateJul = 1373846400000.0;    
