...
void IntlTestNumberFormatAPI::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
...
void IntlTestNumberFormatAPI::testAPI()
{
    UErrorCode status = U_ZERO_ERROR;
...
public:
    ...
    virtual NumberFormat* createFormat(const Locale& , UNumberFormatStyle formatType)
    {
...
IntlTestNumberFormatAPI::testRegistration() 
{
    ...
    NumberFormat::unregister(key, status); 
