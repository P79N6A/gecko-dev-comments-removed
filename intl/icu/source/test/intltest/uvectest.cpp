...
void UVectorTest::runIndexedTest( int32_t index, UBool exec, const char* &name, char*  )
{
...
U_CDECL_BEGIN
static UBool U_CALLCONV neverTRUE(const UElement , const UElement ) {
    return FALSE;
}
