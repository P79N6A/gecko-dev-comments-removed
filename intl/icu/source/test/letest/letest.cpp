...
static void U_CALLCONV ParamTest(void)
{
    ...
    LEUnicode chars[] = {
        0x0045, 0x006E, 0x0067, 0x006C, 0x0069, 0x0073, 0x0068, 0x0020, 
        0x0645, 0x0627, 0x0646, 0x062A, 0x0648, 0x0634,                 
        0x0020, 0x0074, 0x0065, 0x0078, 0x0074, 0x02E                   
    };
...
static void U_CALLCONV GlyphToCharTest(void)
{
    ...
    LEUnicode chars[] = {
         0x0054, 0x0068, 0x0065, 0x0020, 0x004c, 0x0061, 0x0079, 
