...
void FontObject::initUnicodeCMAP()
{
    ...
    cmStartCodes = &header->endCodes[cmSegCount + 1]; 
...
{
    if (hmtxTable == NULL) {
        LETag maxpTag = 0x6D617870; 
        LETag hheaTag = 0x68686561; 
        LETag hmtxTag = 0x686D7478; 
        le_uint32 length;
        HHEATable *hheaTable;
