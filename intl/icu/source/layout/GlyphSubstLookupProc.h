...
private:
    ...
    GlyphSubstitutionLookupProcessor(const GlyphSubstitutionLookupProcessor &other); 
    GlyphSubstitutionLookupProcessor &operator=(const GlyphSubstitutionLookupProcessor &other); 
};
