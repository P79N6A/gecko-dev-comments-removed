...
protected:
    ...
    LEReferenceTo<StateTableHeader2> stHeader; 

private:
    StateTableProcessor2(const StateTableProcessor2 &other); 
    StateTableProcessor2 &operator=(const StateTableProcessor2 &other); 
};
