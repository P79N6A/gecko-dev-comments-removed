...
private:
    ...
    GlyphPositioningLookupProcessor(const GlyphPositioningLookupProcessor &other); 
    GlyphPositioningLookupProcessor &operator=(const GlyphPositioningLookupProcessor &other); 
};
