...
static char* parseFilename(const char* id, char* ) {
...
static void printAttribute(const char *name, const char *value, int32_t )
{
    write_utf8_file(out, UnicodeString(" "));
...
static void printAttribute(const char *name, const UnicodeString value, int32_t )
{
    write_utf8_file(out, UnicodeString(" "));
    write_utf8_file(out, UnicodeString(name));
    write_utf8_file(out, UnicodeString(" = \""));
...
static const char *application_mimetype = "application"; 
...
static void
string_write_xml(struct SResource *res, const char* id, const char* , UErrorCode *status) {
...
static void
alias_write_xml(struct SResource *res, const char* id, const char* , UErrorCode *status) {
    char *sid = NULL;
    char* buf = NULL;
    int32_t bufLen=0;
...
static void
intvector_write_xml(struct SResource *res, const char* id, const char* , UErrorCode *status) {
    char* sid = NULL;
    char* ivd = NULL;
    uint32_t i=0;
    uint32_t len=0;
...
static void
int_write_xml(struct SResource *res, const char* id, const char* , UErrorCode *status) {
    char* sid = NULL;
    char buf[256] = {0};
    uint32_t len = 0;
...
static void
bin_write_xml(struct SResource *res, const char* id, const char* , UErrorCode *status) {
