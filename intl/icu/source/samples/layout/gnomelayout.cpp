...
void showabout(GtkWidget *, gpointer )
{
    GtkWidget *aboutBox;
...
void notimpl(GtkObject *, gpointer )
{
...
void openOK(GtkObject *, gpointer data)
{
...
void openfile(GtkObject *, gpointer data)
{
...
void newapp(GtkObject *, gpointer )
{
...
void closeapp(GtkWidget *, gpointer data)
{
  GtkWidget *app = GTK_WIDGET(data);
...
gint eventDelete(GtkWidget *widget, GdkEvent *, gpointer )
{
  closeSample(widget);
...
gint eventConfigure(GtkWidget *, GdkEventConfigure *event, Context *context)
{
  if (context->paragraph != NULL) {
...
gint eventExpose(GtkWidget *widget, GdkEvent *, Context *context)
{
  if (context->paragraph != NULL) {
