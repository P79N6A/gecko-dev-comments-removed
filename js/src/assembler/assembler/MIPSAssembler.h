...
public:
    ...
    {
        MIPSWord* insn = reinterpret_cast<MIPSWord*>(reinterpret_cast<intptr_t>(code) + from.m_offset);
        ASSERT((*insn & 0xffe00000) == 0x3c000000); 
...
private:
    ...
    void relocateJumps(void* oldBase, void* newBase)
    {
        ...
        for (Jumps::Iterator iter = m_jumps.begin(); iter != m_jumps.end(); ++iter) {
            ...
            } else if ((*insn & 0xffe00000) == 0x3c000000) { 
    ...
    {
        ASSERT((*insn & 0xfc000000) == 0x10000000 
               || (*insn & 0xfc000000) == 0x14000000 
               || (*insn & 0xffff0000) == 0x45010000 
               || (*insn & 0xffff0000) == 0x45000000); 
        ...
        if (diff < -32768 || diff > 32767 || *(insn + 2) != 0x10000003) {
            ...
            if (*(insn + 2) == 0x10000003) {
                if ((*insn & 0xfc000000) == 0x10000000) 
                    *insn = (*insn & 0x03ff0000) | 0x14000005; 
                else if ((*insn & 0xfc000000) == 0x14000000) 
                    *insn = (*insn & 0x03ff0000) | 0x10000005; 
                else if ((*insn & 0xffff0000) == 0x45010000) 
                    *insn = 0x45000005; 
    ...
    static int linkCallInternal(void* from, void* to)
    {
        ...
        if ((*(insn + 2) & 0xfc000000) == 0x0c000000) { 
        ...
        ASSERT((*insn & 0xffe00000) == 0x3c000000); 
        ASSERT((*(insn + 1) & 0xfc000000) == 0x34000000); 
