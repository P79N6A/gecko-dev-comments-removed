...
void*
nanojit::Allocator::allocChunk(size_t nbytes, bool )
{
...
FragmentAssembler::assembleFragment(LirTokenStream &in, bool implicitBegin, const LirToken *firstToken)
{
    ...
    while (true) {
        ...
        switch (mOpcode) {
          ...
          case LIR_j:
            ins = assemble_jump(false);
            break;

          case LIR_jt:
          case LIR_jf:
            ins = assemble_jump(true);
            break;
          ...
          case LIR_x:
          case LIR_xbarrier:
            ins = assemble_guard(false);
            break;

          case LIR_xt:
          case LIR_xf:
            ins = assemble_guard(true);
            break;
...
#undef CL___
    ...
    while (n < nIns) {
        ...
        case LIMM_I: {
            ...
            case 0: immI = 0;                  break;
            case 1: immI = 1;                  break;
            case 2: immI = 4 * (rnd(256) + 1); break;  
            case 3: immI = rnd(19999) - 9999;  break;  
            case 4: immI = rndI32();           break;  
            }
        ...
        case LIMM_Q: {
            ...
            case 2: imm64 = 4 * (rnd(256) + 1);                     break;  
            case 3: imm64 = rnd(19999) - 9999;                      break;  
            case 4: imm64 = uint64_t(rndU32()) << 32 | rndU32();    break;  
            }
        ...
        case LIMM_D: {
            ...
            case 2:
            case 3: imm64f = double(rnd(1000));                             break;  
            case 4:
                union {
                    double d;
                    uint64_t q;
    ...
    if (func != mFragments.end()) {
        ...
        if (func->second.mReturnType == RT_DOUBLE) {
            CallInfo target = {(uintptr_t) func->second.rdouble,
                               0, ABI_FASTCALL, 0, ACCSET_STORE_ANY
