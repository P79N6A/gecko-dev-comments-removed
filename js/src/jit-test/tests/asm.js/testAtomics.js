...
function test_int32(heap) {
    ...
    i32a[200] = 78;
    assertEq(i32m.xchg(), 78);	
    assertEq(i32a[0], 37);
    assertEq(i32m.xchg_i(size*200), 37); 
...
function test_int16(heap) {
    ...
    i16a[200] = 78;
    assertEq(i16m.xchg(), 78);	
    assertEq(i16a[0], 37);
    assertEq(i16m.xchg_i(size*200), 37); 
...
function test_int8(heap) {
    ...
    i8a[200] = 78;
    assertEq(i8m.xchg(), 78);	
    assertEq(i8a[0], 37);
    assertEq(i8m.xchg_i(size*200), 37); 
    assertEq(i8a[200], 42);
...
function test_uint8(heap) {
    ...
    assertEq(i8a[20], (49 - 108 - 108) & 255); 
