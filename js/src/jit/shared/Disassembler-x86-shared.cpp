...
js::jit::Disassembler::DisassembleHeapAccess(uint8_t *ptr, HeapAccess *access)
{
    ...
    switch (*ptr) {
      case PRE_LOCK:
      case PRE_PREDICT_BRANCH_NOT_TAKEN: 
      case 0x3E: 
      case 0x36: 
      case 0x26: 
      case 0x64: 
  ...
  opcode_done:;
    ...
    switch (opcode) {
      ...
      case Pack2ByteOpcode(OP2_PSLLD_UdqIb): 
    ...
    switch (opcode) {
      ...
      case Pack2ByteOpcode(OP2_MOVSX_GvEw):
        ...
        kind = HeapAccess::LoadSext32;
        break;
      case Pack2ByteOpcode(OP2_MOVDQ_VdqWdq): 
      case Pack2ByteOpcode(OP2_MOVAPS_VsdWsd):
        ...
        kind = HeapAccess::Load;
        break;
      case Pack2ByteOpcode(OP2_MOVSD_VsdWsd): 
        MOZ_ASSERT(!haveImm);
        otherOperand = OtherOperand(xmm);
        switch (type) {
      ...
      case Pack2ByteOpcode(OP2_MOVDQ_WdqVdq):
        ...
        kind = HeapAccess::Store;
        break;
      case Pack2ByteOpcode(OP2_MOVSD_WsdVsd): 
        MOZ_ASSERT(!haveImm);
        otherOperand = OtherOperand(xmm);
        switch (type) {
          case VEX_SS: memSize = 4; break;
      ...
      case Pack2ByteOpcode(OP2_MOVQ_WdVd):
        ...
        kind = HeapAccess::Store;
        break;
      case Pack2ByteOpcode(OP2_MOVD_EdVd): 
        MOZ_ASSERT(!haveImm);
        otherOperand = OtherOperand(xmm);
        switch (type) {
