...
GetFinalizableThingSize(unsigned thingKind)
{
    ...
    static const uint8 map[FINALIZE_LIMIT] = {
        JSOBJECT_SIZE,                      
        JSOBJECT_SIZE + 2 * sizeof(Value),  
        JSOBJECT_SIZE + 4 * sizeof(Value),  
        JSOBJECT_SIZE + 8 * sizeof(Value),  
        JSOBJECT_SIZE + 12 * sizeof(Value), 
        JSOBJECT_SIZE + 16 * sizeof(Value), 
        sizeof(JSFunction),    
#if JS_HAS_XML_SUPPORT
        sizeof(JSXML),         
#endif
...
JSFinalizeGCThingKind js_GCObjectSlotsToThingKind[] = {
     ...
     FINALIZE_OBJECT16, FINALIZE_OBJECT0,  FINALIZE_OBJECT0,  FINALIZE_OBJECT0,
