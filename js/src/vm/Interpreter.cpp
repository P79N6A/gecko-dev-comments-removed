...
struct AutoStopwatch MOZ_FINAL
{
    ...
    inline ~AutoStopwatch()
    {
        ...
        totalUserTime = (userTimeInt.QuadPart - userTimeStampInt.QuadPart) / 10;  
        ...
        totalSystemTime = (kernelTimeInt.QuadPart - kernelTimeStampInt.QuadPart) / 10;  
#endif 
