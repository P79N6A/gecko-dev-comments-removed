...
#undef S
    ...
    void Assembler::asm_arith_imm(LIns *ins) {
        ...
        if (isS8(imm)) {
            ...
            case LIR_add:
            case LIR_addxov:    ADDLR8(rr, imm);   break;   
            ...
            case LIR_add:
            case LIR_addxov:    ADDLRI(rr, imm);   break;   
    ...
    void Assembler::asm_arith(LIns *ins) {
        ...
        case LIR_add:
        case LIR_addxov:    ADDRR(rr, rb);  break;  
    ...
    RegisterMask Assembler::hint(LIns* ) {
        return 0;
    }
