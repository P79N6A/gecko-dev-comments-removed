...
pref("services.aitc.main.idleTime", 120000); 

pref("services.aitc.manager.putFreq", 10000); 
pref("services.aitc.manager.getActiveFreq", 120000); 
pref("services.aitc.manager.getPassiveFreq", 7200000); 
