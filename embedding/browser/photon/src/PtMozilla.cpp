	...
	switch( argt->type )  
	{
		...
		case Pt_ARG_MOZ_UNKNOWN_RESP: {
			...
			if( unknown->response == Pt_WEB_RESPONSE_CANCEL ) {
				...
				if( d ) {
					if( d->mLauncher ) d->mLauncher->Cancel(NS_BINDING_ABORTED); 
					else if( d->mPersist ) d->mPersist->CancelSave(); 
					else delete d; 
					}
				}
			}
...
mozilla_set_pref( PtWidget_t *widget, char *option, char *value ) 
{
    ...
    pref->SetCharPref( "font.name.monospace.x-western", value );
	...
	else if( !strcmp( option, "socks_user" ) ) 		; 
	else if( !strcmp( option, "socks_app" ) ) 		; 
	...
	else if( !strcmp( option, "email_address" ) )		; 
		...
		if( n == 0 ) moz_value = 2; 
		else if( n == 1 ) moz_value = 0; 
		else if( n == 2 ) moz_value = 1; 


		pref->SetIntPref( "browser.cache.check_doc_frequency", moz_value );
		}
	else if( !strcmp( option, "main_cache_dir" ) ) 		; 
	else if( !strcmp( option, "main_index_file" ) ) 		; 
	else if( !strcmp( option, "clear_main_cache_on_exit" ) ) 		; 
	else if( !strcmp( option, "keep_index_file_updated" ) ) 		; 
	...
	else if( !strcmp( option, "bAutoLoadImages" ) )			; 
	else if( !strcmp( option, "iReformatHandling" ) )		; 
	else if( !strcmp( option, "BODY margin-top" ) )		; 
	else if( !strcmp( option, "BODY margin-right" ) )		; 
	else if( !strcmp( option, "iScrollbarSize" ) )		; 
	else if( !strcmp( option, "top_focus_color" ) )		; 
	else if( !strcmp( option, "bot_focus_color" ) )		; 
	else if( !strcmp( option, "top_border_color" ) )		; 
	else if( !strcmp( option, "bot_border_color" ) )		; 
	else if( !strcmp( option, "bview_source" ) )		; 
	else if( !strcmp( option, "underline_width" ) )		; 
	else if( !strcmp( option, "bkey_mode" ) )		; 
	else if( !strcmp( option, "mono_form_font" ) )		; 
	else if( !strcmp( option, "form_font" ) )		; 
	else if( !strcmp( option, "frame_spacing" ) )		; 
	...
	else if( !strcmp( option, "bDisableHighlight" ) )		; 


	else if( !strcmp( option, "cookiejar_path" ) )		; 
	else if( !strcmp( option, "cookiejar_name" ) )		; 
	else if( !strcmp( option, "cookiejar_size" ) )		; 
	else if( !strcmp( option, "cookiejar_save_always" ) )		; 


	else if( !strcmp( option, "max_password_guesses" ) )		; 


	else if( !strcmp( option, "file_display_dir" ) )		; 


	else if( !strcmp( option, "bProgressiveImageDisplay" ) ) 		; 
	else if( !strcmp( option, "quantize_jpegs" ) ) 		; 
	else if( !strcmp( option, "concurrent_decodes" ) ) 		; 



	else if( !strcmp( option, "Print_Header_Font" ) ) 		; 
	else if( !strcmp( option, "Print_Header_Font_Size" ) ) 		; 
	...
	else if( !strcmp( option, "Global_History_File" ) ) 		; 
	else if( !strcmp( option, "IBeam_Cursor" ) ) 		; 
	else if( !strcmp( option, "Image_Cache_Size_KB" ) ) 		; 
	else if( !strcmp( option, "ImageMap_Cursor" ) ) 		; 
	else if( !strcmp( option, "ImageMap_Cursor_NoLink" ) ) 		; 
	else if( !strcmp( option, "Link_Cursor" ) ) 		; 
	else if( !strcmp( option, "LinkWait_Cursor" ) ) 		; 
	else if( !strcmp( option, "Normal_Cursor" ) ) 		; 
	else if( !strcmp( option, "NormalWait_Cursor" ) ) 		; 
	else if( !strcmp( option, "Page_Cache_Size" ) ) 		; 
	else if( !strcmp( option, "Safe_Memory_Free" ) ) 		; 
	else if( !strcmp( option, "Site_History_Length" ) ) 		; 
	else if( !strcmp( option, "Show_Server_Errors" ) ) 		; 
	else if( !strcmp( option, "Use_Anti_Alias" ) ) 		; 
	else if( !strcmp( option, "Use_Explicit_Accept_Headers" ) ) 		; 
	else if( !strcmp( option, "Visitation_Horizon" ) ) 		; 
