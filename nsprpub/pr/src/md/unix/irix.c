...
PRInt32 _pr_irix_process_exit_code = 0;	
PRInt32 _pr_irix_process_exit = 0; 
...
static void _MD_IrixIntervalInit(void)
{
        ...
        && ((mmem_fd = open("/dev/mmem", O_RDONLY)) != -1))
    {
        ...
        pr_clock_mask = pr_clock_granularity - 1;  
