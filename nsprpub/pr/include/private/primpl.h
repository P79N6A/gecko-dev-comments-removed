...
struct _PRCPUQueue {
    ...
    PRCList runQ[PR_PRIORITY_LAST + 1]; 
...
extern PRUint32 _pr_recycleThreads;   
...
extern PRLock *_pr_activeLock;          
extern PRInt32 _pr_userActive;          
extern PRInt32 _pr_systemActive;        
extern PRInt32 _pr_primordialExitCount; 


extern PRCondVar *_pr_primordialExitCVar; 
