...
nsAccessible*
nsAccessibilityService::GetAccessibleOrContainer(nsINode* aNode, nsIPresShell* aPresShell)
{
  if (!aNode)
    return nsnull;

  nsDocAccessible* document = nsAccUtils::GetDocAccessibleFor(aPresShell);
