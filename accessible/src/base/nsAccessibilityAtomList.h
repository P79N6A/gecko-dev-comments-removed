...
ACCESSIBILITY_ATOM(article, "article") 
ACCESSIBILITY_ATOM(aside, "aside") 
...
ACCESSIBILITY_ATOM(choices, "choices") 
ACCESSIBILITY_ATOM(description, "description")    
ACCESSIBILITY_ATOM(dd, "dd")
ACCESSIBILITY_ATOM(div, "div")
ACCESSIBILITY_ATOM(dl, "dl")
ACCESSIBILITY_ATOM(dt, "dt")
ACCESSIBILITY_ATOM(footer, "footer") 
ACCESSIBILITY_ATOM(form, "form")
ACCESSIBILITY_ATOM(header, "header") 
...
ACCESSIBILITY_ATOM(item, "item") 
ACCESSIBILITY_ATOM(itemset, "itemset") 
...
ACCESSIBILITY_ATOM(listcell, "listcell") 
ACCESSIBILITY_ATOM(listcols, "listcols") 
ACCESSIBILITY_ATOM(listcol, "listcol") 
ACCESSIBILITY_ATOM(listhead, "listhead") 
ACCESSIBILITY_ATOM(listheader, "listheader") 
ACCESSIBILITY_ATOM(map, "map")
ACCESSIBILITY_ATOM(math, "math")
ACCESSIBILITY_ATOM(menupopup, "menupopup")     
ACCESSIBILITY_ATOM(object, "object")
ACCESSIBILITY_ATOM(nav, "nav") 
...
ACCESSIBILITY_ATOM(textarea, "textarea") 
ACCESSIBILITY_ATOM(textbox, "textbox")   
ACCESSIBILITY_ATOM(toolbaritem, "toolbaritem")   
ACCESSIBILITY_ATOM(toolbarseparator, "toolbarseparator")   
ACCESSIBILITY_ATOM(toolbarspring, "toolbarspring")   
...
ACCESSIBILITY_ATOM(anonid, "anonid") 
...
ACCESSIBILITY_ATOM(_default, "default") 
ACCESSIBILITY_ATOM(draggable, "draggable")
ACCESSIBILITY_ATOM(droppable, "droppable")   
ACCESSIBILITY_ATOM(editable, "editable")
ACCESSIBILITY_ATOM(_for, "for")
ACCESSIBILITY_ATOM(headers, "headers")   
ACCESSIBILITY_ATOM(hidden, "hidden")   
ACCESSIBILITY_ATOM(hover, "hover") 
ACCESSIBILITY_ATOM(href, "href") 
ACCESSIBILITY_ATOM(increment, "increment") 
ACCESSIBILITY_ATOM(lang, "lang")
ACCESSIBILITY_ATOM(linkedPanel, "linkedpanel") 
ACCESSIBILITY_ATOM(longDesc, "longdesc")
ACCESSIBILITY_ATOM(max, "max") 
ACCESSIBILITY_ATOM(maxpos, "maxpos") 
ACCESSIBILITY_ATOM(minpos, "minpos") 
ACCESSIBILITY_ATOM(_moz_menuactive, "_moz-menuactive") 
...
ACCESSIBILITY_ATOM(scope, "scope") 
ACCESSIBILITY_ATOM(seltype, "seltype") 
ACCESSIBILITY_ATOM(simple, "simple") 
