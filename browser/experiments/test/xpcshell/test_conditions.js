...
add_task(function* test_simpleFields() {
  let testData = [
    ...
    [true,  null, {jsfilter: "function filter(c) { return 123; }"}], 
    [false, ["jsfilter-false"], {jsfilter: "function filter(c) { return ''; }"}], 
    [false, ["jsfilter-false"], {jsfilter: "function filter(c) { var a = []; }"}], 
