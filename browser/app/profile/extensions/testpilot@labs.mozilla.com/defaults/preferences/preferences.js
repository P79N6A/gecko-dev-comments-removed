...
pref("extensions.testpilot.popup.delayAfterStartup", 180000); 
pref("extensions.testpilot.popup.timeBetweenChecks", 86400000); 
pref("extensions.testpilot.uploadRetryInterval", 3600000); 
