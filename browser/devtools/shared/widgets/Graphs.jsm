...
const GRAPH_STRIPE_PATTERN_LINE_WIDTH = 4; 
const GRAPH_STRIPE_PATTERN_LINE_SPACING = 8; 



const LINE_GRAPH_DAMPEN_VALUES = 0.85;
const LINE_GRAPH_MIN_SQUARED_DISTANCE_BETWEEN_POINTS = 400; 
const LINE_GRAPH_TOOLTIP_SAFE_BOUNDS = 10; 

const LINE_GRAPH_STROKE_WIDTH = 2; 
...
const BAR_GRAPH_BARS_MARGIN_END = 2; 
