...
TreeView.prototype = {
  ...
  _toggle: function TreeView__toggle(div,  newCollapsedValue,  suppressScrollHeightNotification) {
  ...
  _toggleAll: function TreeView__toggleAll(subtreeRoot,  newCollapsedValue,  suppressScrollHeightNotification) {
  ...
  _scrollIntoView: function TreeView__scrollIntoView(element, maxImportantWidth) {
    ...
    var visibleRect = {
      left: this._horizontalScrollbox.getBoundingClientRect().left + 150, 
