...
function setupDownloads() {
  ...
  let data = {
    ...
    startTime: now_uSec - 10*60*1000000,  
    endTime: now_uSec - 11*60*1000000, 
  ...
  data = {
    ...
    startTime: now_uSec - 70*60*1000000,  
    endTime: now_uSec - 71*60*1000000, 
    state: Ci.nsIDownloadManager.DOWNLOAD_FINISHED,
    currBytes: 0, maxBytes: -1, preferredAction: 0, autoResume: 0
  };
  ...
  data = {
    ...
    startTime: now_uSec - 130*60*1000000,  
    endTime: now_uSec - 131*60*1000000, 
    state: Ci.nsIDownloadManager.DOWNLOAD_FINISHED,
    currBytes: 0, maxBytes: -1, preferredAction: 0, autoResume: 0
  };
  ...
  data = {
    ...
    startTime: now_uSec - 250*60*1000000,  
    endTime: now_uSec - 251*60*1000000, 
    state: Ci.nsIDownloadManager.DOWNLOAD_FINISHED,
    currBytes: 0, maxBytes: -1, preferredAction: 0, autoResume: 0
  };
